...
/// * [quantityReserved]
@BuiltValue()
abstract class InventoryKpisStockSumDto
    implements
        Built<InventoryKpisStockSumDto, InventoryKpisStockSumDtoBuilder> {
  ...
  factory InventoryKpisStockSumDto(
          [void updates(InventoryKpisStockSumDtoBuilder b)]) =
      _$InventoryKpisStockSumDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InventoryKpisStockSumDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InventoryKpisStockSumDto> get serializer =>
      _$InventoryKpisStockSumDtoSerializer();
}

class _$InventoryKpisStockSumDtoSerializer
    implements PrimitiveSerializer<InventoryKpisStockSumDto> {
  @override
