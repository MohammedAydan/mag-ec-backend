...
/// * [quantity]
@BuiltValue()
abstract class OrderShipmentItemDto
    implements Built<OrderShipmentItemDto, OrderShipmentItemDtoBuilder> {
  ...
  factory OrderShipmentItemDto([void updates(OrderShipmentItemDtoBuilder b)]) =
      _$OrderShipmentItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderShipmentItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderShipmentItemDto> get serializer =>
      _$OrderShipmentItemDtoSerializer();
}

class _$OrderShipmentItemDtoSerializer
    implements PrimitiveSerializer<OrderShipmentItemDto> {
  @override
