...
/// * [payment]
@BuiltValue()
abstract class CheckoutPlaceOrderResponseDto
    implements
        Built<CheckoutPlaceOrderResponseDto,
  ...
  factory CheckoutPlaceOrderResponseDto(
          [void updates(CheckoutPlaceOrderResponseDtoBuilder b)]) =
      _$CheckoutPlaceOrderResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPlaceOrderResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPlaceOrderResponseDto> get serializer =>
      _$CheckoutPlaceOrderResponseDtoSerializer();
}

class _$CheckoutPlaceOrderResponseDtoSerializer
    implements PrimitiveSerializer<CheckoutPlaceOrderResponseDto> {
  @override
