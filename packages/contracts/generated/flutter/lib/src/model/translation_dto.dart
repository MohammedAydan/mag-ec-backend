...
/// * [description]
@BuiltValue()
abstract class TranslationDto
    implements Built<TranslationDto, TranslationDtoBuilder> {
  ...
  factory TranslationDto([void updates(TranslationDtoBuilder b)]) =
      _$TranslationDto;
  ...
  static Serializer<TranslationDto> get serializer =>
      _$TranslationDtoSerializer();
}

class _$TranslationDtoSerializer
    implements PrimitiveSerializer<TranslationDto> {
  @override
