...
/// * [processedAt]
@BuiltValue()
abstract class OrderRefundDto
    implements Built<OrderRefundDto, OrderRefundDtoBuilder> {
  ...
  factory OrderRefundDto([void updates(OrderRefundDtoBuilder b)]) =
      _$OrderRefundDto;
  ...
  static Serializer<OrderRefundDto> get serializer =>
      _$OrderRefundDtoSerializer();
}

class _$OrderRefundDtoSerializer
    implements PrimitiveSerializer<OrderRefundDto> {
  @override
