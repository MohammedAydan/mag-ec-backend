...
/// * [pageSize]
@BuiltValue()
abstract class PaginatedCatalogProductsDto
    implements
        Built<PaginatedCatalogProductsDto, PaginatedCatalogProductsDtoBuilder> {
  ...
  factory PaginatedCatalogProductsDto(
          [void updates(PaginatedCatalogProductsDtoBuilder b)]) =
      _$PaginatedCatalogProductsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedCatalogProductsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedCatalogProductsDto> get serializer =>
      _$PaginatedCatalogProductsDtoSerializer();
}

class _$PaginatedCatalogProductsDtoSerializer
    implements PrimitiveSerializer<PaginatedCatalogProductsDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(CatalogProductSummaryDto)]),
    );
    yield r'total';
    yield serializers.serialize(
      object.total,
