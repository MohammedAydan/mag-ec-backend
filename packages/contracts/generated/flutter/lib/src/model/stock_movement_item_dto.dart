...
/// * [actorUser]
@BuiltValue()
abstract class StockMovementItemDto
    implements Built<StockMovementItemDto, StockMovementItemDtoBuilder> {
  ...
  factory StockMovementItemDto([void updates(StockMovementItemDtoBuilder b)]) =
      _$StockMovementItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StockMovementItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StockMovementItemDto> get serializer =>
      _$StockMovementItemDtoSerializer();
}

class _$StockMovementItemDtoSerializer
    implements PrimitiveSerializer<StockMovementItemDto> {
  @override
