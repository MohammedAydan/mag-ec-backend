...
/// * [sortOrder]
@BuiltValue()
abstract class ProductTypeAttributeLinkDto
    implements
        Built<ProductTypeAttributeLinkDto, ProductTypeAttributeLinkDtoBuilder> {
  ...
  factory ProductTypeAttributeLinkDto(
          [void updates(ProductTypeAttributeLinkDtoBuilder b)]) =
      _$ProductTypeAttributeLinkDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductTypeAttributeLinkDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductTypeAttributeLinkDto> get serializer =>
      _$ProductTypeAttributeLinkDtoSerializer();
}

class _$ProductTypeAttributeLinkDtoSerializer
    implements PrimitiveSerializer<ProductTypeAttributeLinkDto> {
  @override
