...
/// * [estimatedMaxDays]
@BuiltValue()
abstract class CheckoutPreviewShippingMethodDto
    implements
        Built<CheckoutPreviewShippingMethodDto,
  ...
  factory CheckoutPreviewShippingMethodDto(
          [void updates(CheckoutPreviewShippingMethodDtoBuilder b)]) =
      _$CheckoutPreviewShippingMethodDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPreviewShippingMethodDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPreviewShippingMethodDto> get serializer =>
      _$CheckoutPreviewShippingMethodDtoSerializer();
}

class _$CheckoutPreviewShippingMethodDtoSerializer
    implements PrimitiveSerializer<CheckoutPreviewShippingMethodDto> {
  @override
