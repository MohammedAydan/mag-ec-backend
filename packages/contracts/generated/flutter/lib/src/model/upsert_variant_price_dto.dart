...
@BuiltValue()
abstract class UpsertVariantPriceDto
    implements Built<UpsertVariantPriceDto, UpsertVariantPriceDtoBuilder> {
  ...
  factory UpsertVariantPriceDto(
      [void updates(UpsertVariantPriceDtoBuilder b)]) = _$UpsertVariantPriceDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertVariantPriceDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertVariantPriceDto> get serializer =>
      _$UpsertVariantPriceDtoSerializer();
}

class _$UpsertVariantPriceDtoSerializer
    implements PrimitiveSerializer<UpsertVariantPriceDto> {
  @override
  final Iterable<Type> types = const [
    UpsertVariantPriceDto,
    _$UpsertVariantPriceDto
  ];
