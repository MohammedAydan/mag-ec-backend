...
@BuiltValue()
abstract class CreateAdminRoleDto
    implements Built<CreateAdminRoleDto, CreateAdminRoleDtoBuilder> {
  ...
  factory CreateAdminRoleDto([void updates(CreateAdminRoleDtoBuilder b)]) =
      _$CreateAdminRoleDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateAdminRoleDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateAdminRoleDto> get serializer =>
      _$CreateAdminRoleDtoSerializer();
}

class _$CreateAdminRoleDtoSerializer
    implements PrimitiveSerializer<CreateAdminRoleDto> {
  @override
