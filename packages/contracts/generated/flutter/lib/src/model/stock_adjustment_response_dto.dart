...
/// * [actorUserId]
@BuiltValue()
abstract class StockAdjustmentResponseDto
    implements
        Built<StockAdjustmentResponseDto, StockAdjustmentResponseDtoBuilder> {
  ...
  factory StockAdjustmentResponseDto(
          [void updates(StockAdjustmentResponseDtoBuilder b)]) =
      _$StockAdjustmentResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StockAdjustmentResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StockAdjustmentResponseDto> get serializer =>
      _$StockAdjustmentResponseDtoSerializer();
}

class _$StockAdjustmentResponseDtoSerializer
    implements PrimitiveSerializer<StockAdjustmentResponseDto> {
  @override
