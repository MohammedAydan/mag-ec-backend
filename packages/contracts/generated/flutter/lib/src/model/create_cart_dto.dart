...
@BuiltValue()
abstract class CreateCartDto
    implements Built<CreateCartDto, CreateCartDtoBuilder> {
  ...
  factory CreateCartDto([void updates(CreateCartDtoBuilder b)]) =
      _$CreateCartDto;
  ...
  static Serializer<CreateCartDto> get serializer =>
      _$CreateCartDtoSerializer();
}
