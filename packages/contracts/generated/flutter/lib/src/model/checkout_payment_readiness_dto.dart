...
@BuiltValue()
abstract class CheckoutPaymentReadinessDto
    implements
        Built<CheckoutPaymentReadinessDto, CheckoutPaymentReadinessDtoBuilder> {
  ...
  factory CheckoutPaymentReadinessDto(
          [void updates(CheckoutPaymentReadinessDtoBuilder b)]) =
      _$CheckoutPaymentReadinessDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPaymentReadinessDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPaymentReadinessDto> get serializer =>
      _$CheckoutPaymentReadinessDtoSerializer();
}

class _$CheckoutPaymentReadinessDtoSerializer
    implements PrimitiveSerializer<CheckoutPaymentReadinessDto> {
  @override
