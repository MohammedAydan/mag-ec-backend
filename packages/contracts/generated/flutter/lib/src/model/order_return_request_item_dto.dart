...
/// * [restockedAt]
@BuiltValue()
abstract class OrderReturnRequestItemDto
    implements
        Built<OrderReturnRequestItemDto, OrderReturnRequestItemDtoBuilder> {
  ...
  factory OrderReturnRequestItemDto(
          [void updates(OrderReturnRequestItemDtoBuilder b)]) =
      _$OrderReturnRequestItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderReturnRequestItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderReturnRequestItemDto> get serializer =>
      _$OrderReturnRequestItemDtoSerializer();
}

class _$OrderReturnRequestItemDtoSerializer
    implements PrimitiveSerializer<OrderReturnRequestItemDto> {
  @override
