...
/// * [optionId]
@BuiltValue()
abstract class VariantOptionValueDto
    implements Built<VariantOptionValueDto, VariantOptionValueDtoBuilder> {
  ...
  factory VariantOptionValueDto(
      [void updates(VariantOptionValueDtoBuilder b)]) = _$VariantOptionValueDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VariantOptionValueDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VariantOptionValueDto> get serializer =>
      _$VariantOptionValueDtoSerializer();
}

class _$VariantOptionValueDtoSerializer
    implements PrimitiveSerializer<VariantOptionValueDto> {
  @override
  final Iterable<Type> types = const [
    VariantOptionValueDto,
    _$VariantOptionValueDto
  ];
