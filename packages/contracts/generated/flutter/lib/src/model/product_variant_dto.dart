...
/// * [position]
@BuiltValue()
abstract class ProductVariantDto
    implements Built<ProductVariantDto, ProductVariantDtoBuilder> {
  ...
  factory ProductVariantDto([void updates(ProductVariantDtoBuilder b)]) =
      _$ProductVariantDto;
  ...
  static Serializer<ProductVariantDto> get serializer =>
      _$ProductVariantDtoSerializer();
}

class _$ProductVariantDtoSerializer
    implements PrimitiveSerializer<ProductVariantDto> {
  @override
