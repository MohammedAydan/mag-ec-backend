...
/// * [translations]
@BuiltValue()
abstract class UpdateProductDto
    implements Built<UpdateProductDto, UpdateProductDtoBuilder> {
  ...
  factory UpdateProductDto([void updates(UpdateProductDtoBuilder b)]) =
      _$UpdateProductDto;
  ...
  static Serializer<UpdateProductDto> get serializer =>
      _$UpdateProductDtoSerializer();
}

class _$UpdateProductDtoSerializer
    implements PrimitiveSerializer<UpdateProductDto> {
  @override
