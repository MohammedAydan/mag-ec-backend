...
/// * [freeShipping]
@BuiltValue()
abstract class PricingPreviewAppliedPromotionDto
    implements
        Built<PricingPreviewAppliedPromotionDto,
  ...
  factory PricingPreviewAppliedPromotionDto(
          [void updates(PricingPreviewAppliedPromotionDtoBuilder b)]) =
      _$PricingPreviewAppliedPromotionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PricingPreviewAppliedPromotionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PricingPreviewAppliedPromotionDto> get serializer =>
      _$PricingPreviewAppliedPromotionDtoSerializer();
}

class _$PricingPreviewAppliedPromotionDtoSerializer
    implements PrimitiveSerializer<PricingPreviewAppliedPromotionDto> {
  @override
