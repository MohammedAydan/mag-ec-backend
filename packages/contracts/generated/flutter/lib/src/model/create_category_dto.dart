...
abstract class CreateCategoryDto
    implements Built<CreateCategoryDto, CreateCategoryDtoBuilder> {
  ...
  factory CreateCategoryDto([void updates(CreateCategoryDtoBuilder b)]) =
      _$CreateCategoryDto;
  ...
  static Serializer<CreateCategoryDto> get serializer =>
      _$CreateCategoryDtoSerializer();
}

class _$CreateCategoryDtoSerializer
    implements PrimitiveSerializer<CreateCategoryDto> {
  @override
