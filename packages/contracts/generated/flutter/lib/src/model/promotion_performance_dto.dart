...
/// * [sum]
@BuiltValue()
abstract class PromotionPerformanceDto
    implements Built<PromotionPerformanceDto, PromotionPerformanceDtoBuilder> {
  ...
  factory PromotionPerformanceDto(
          [void updates(PromotionPerformanceDtoBuilder b)]) =
      _$PromotionPerformanceDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PromotionPerformanceDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PromotionPerformanceDto> get serializer =>
      _$PromotionPerformanceDtoSerializer();
}

class _$PromotionPerformanceDtoSerializer
    implements PrimitiveSerializer<PromotionPerformanceDto> {
  @override
