...
/// * [failedAt]
@BuiltValue()
abstract class ReportExportResponseDto
    implements Built<ReportExportResponseDto, ReportExportResponseDtoBuilder> {
  ...
  factory ReportExportResponseDto(
          [void updates(ReportExportResponseDtoBuilder b)]) =
      _$ReportExportResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReportExportResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReportExportResponseDto> get serializer =>
      _$ReportExportResponseDtoSerializer();
}

class _$ReportExportResponseDtoSerializer
    implements PrimitiveSerializer<ReportExportResponseDto> {
  @override
