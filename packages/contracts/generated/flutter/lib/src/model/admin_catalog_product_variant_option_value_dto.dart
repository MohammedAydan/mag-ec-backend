...
/// * [option]
@BuiltValue()
abstract class AdminCatalogProductVariantOptionValueDto
    implements
        Built<AdminCatalogProductVariantOptionValueDto,
  ...
  factory AdminCatalogProductVariantOptionValueDto(
          [void updates(AdminCatalogProductVariantOptionValueDtoBuilder b)]) =
      _$AdminCatalogProductVariantOptionValueDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogProductVariantOptionValueDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogProductVariantOptionValueDto> get serializer =>
      _$AdminCatalogProductVariantOptionValueDtoSerializer();
}

class _$AdminCatalogProductVariantOptionValueDtoSerializer
    implements PrimitiveSerializer<AdminCatalogProductVariantOptionValueDto> {
  @override
