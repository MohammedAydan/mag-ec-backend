...
/// * [accepted]
@BuiltValue()
abstract class PasswordResetRequestResponseDto
    implements
        Built<PasswordResetRequestResponseDto,
  ...
  factory PasswordResetRequestResponseDto(
          [void updates(PasswordResetRequestResponseDtoBuilder b)]) =
      _$PasswordResetRequestResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PasswordResetRequestResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PasswordResetRequestResponseDto> get serializer =>
      _$PasswordResetRequestResponseDtoSerializer();
}

class _$PasswordResetRequestResponseDtoSerializer
    implements PrimitiveSerializer<PasswordResetRequestResponseDto> {
  @override
