...
/// * [closedAt]
@BuiltValue()
abstract class ReturnRequestResponseDto
    implements
        Built<ReturnRequestResponseDto, ReturnRequestResponseDtoBuilder> {
  ...
  factory ReturnRequestResponseDto(
          [void updates(ReturnRequestResponseDtoBuilder b)]) =
      _$ReturnRequestResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReturnRequestResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReturnRequestResponseDto> get serializer =>
      _$ReturnRequestResponseDtoSerializer();
}

class _$ReturnRequestResponseDtoSerializer
    implements PrimitiveSerializer<ReturnRequestResponseDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(ReturnRequestItemResponseDto)]),
    );
    yield r'refunds';
    yield serializers.serialize(
      object.refunds,
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(ReturnRequestItemResponseDto)]),
