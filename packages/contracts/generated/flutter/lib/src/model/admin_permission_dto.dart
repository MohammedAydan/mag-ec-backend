...
/// * [description]
@BuiltValue()
abstract class AdminPermissionDto
    implements Built<AdminPermissionDto, AdminPermissionDtoBuilder> {
  ...
  factory AdminPermissionDto([void updates(AdminPermissionDtoBuilder b)]) =
      _$AdminPermissionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminPermissionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminPermissionDto> get serializer =>
      _$AdminPermissionDtoSerializer();
}

class _$AdminPermissionDtoSerializer
    implements PrimitiveSerializer<AdminPermissionDto> {
  @override
