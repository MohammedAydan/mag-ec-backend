...
/// * [metaDescription]
@BuiltValue()
abstract class ProductTranslationDto
    implements Built<ProductTranslationDto, ProductTranslationDtoBuilder> {
  ...
  factory ProductTranslationDto(
      [void updates(ProductTranslationDtoBuilder b)]) = _$ProductTranslationDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductTranslationDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductTranslationDto> get serializer =>
      _$ProductTranslationDtoSerializer();
}

class _$ProductTranslationDtoSerializer
    implements PrimitiveSerializer<ProductTranslationDto> {
  @override
  final Iterable<Type> types = const [
    ProductTranslationDto,
    _$ProductTranslationDto
  ];
