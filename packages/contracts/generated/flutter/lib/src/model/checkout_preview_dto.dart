...
@BuiltValue()
abstract class CheckoutPreviewDto
    implements Built<CheckoutPreviewDto, CheckoutPreviewDtoBuilder> {
  ...
  factory CheckoutPreviewDto([void updates(CheckoutPreviewDtoBuilder b)]) =
      _$CheckoutPreviewDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPreviewDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPreviewDto> get serializer =>
      _$CheckoutPreviewDtoSerializer();
}

class _$CheckoutPreviewDtoSerializer
    implements PrimitiveSerializer<CheckoutPreviewDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(CheckoutPreviewItemDto)]),
    );
