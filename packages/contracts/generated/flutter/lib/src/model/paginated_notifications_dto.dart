...
/// * [nextCursor]
@BuiltValue()
abstract class PaginatedNotificationsDto
    implements
        Built<PaginatedNotificationsDto, PaginatedNotificationsDtoBuilder> {
  ...
  factory PaginatedNotificationsDto(
          [void updates(PaginatedNotificationsDtoBuilder b)]) =
      _$PaginatedNotificationsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedNotificationsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedNotificationsDto> get serializer =>
      _$PaginatedNotificationsDtoSerializer();
}

class _$PaginatedNotificationsDtoSerializer
    implements PrimitiveSerializer<PaginatedNotificationsDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(NotificationResponseDto)]),
    );
