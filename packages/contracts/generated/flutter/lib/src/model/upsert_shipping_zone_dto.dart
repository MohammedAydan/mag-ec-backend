...
@BuiltValue()
abstract class UpsertShippingZoneDto
    implements Built<UpsertShippingZoneDto, UpsertShippingZoneDtoBuilder> {
  ...
  factory UpsertShippingZoneDto(
      [void updates(UpsertShippingZoneDtoBuilder b)]) = _$UpsertShippingZoneDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertShippingZoneDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertShippingZoneDto> get serializer =>
      _$UpsertShippingZoneDtoSerializer();
}

class _$UpsertShippingZoneDtoSerializer
    implements PrimitiveSerializer<UpsertShippingZoneDto> {
  @override
  final Iterable<Type> types = const [
    UpsertShippingZoneDto,
    _$UpsertShippingZoneDto
  ];
