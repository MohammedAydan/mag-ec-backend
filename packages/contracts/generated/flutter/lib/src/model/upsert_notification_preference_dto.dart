...
@BuiltValue()
abstract class UpsertNotificationPreferenceDto
    implements
        Built<UpsertNotificationPreferenceDto,
  ...
  factory UpsertNotificationPreferenceDto(
          [void updates(UpsertNotificationPreferenceDtoBuilder b)]) =
      _$UpsertNotificationPreferenceDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertNotificationPreferenceDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertNotificationPreferenceDto> get serializer =>
      _$UpsertNotificationPreferenceDtoSerializer();
}

class _$UpsertNotificationPreferenceDtoSerializer
    implements PrimitiveSerializer<UpsertNotificationPreferenceDto> {
  @override
      ...
      switch (key) {
        case r'channel':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(UpsertNotificationPreferenceDtoChannelEnum),
...
class UpsertNotificationPreferenceDtoChannelEnum extends EnumClass {
  ...
  static const UpsertNotificationPreferenceDtoChannelEnum EMAIL =
      _$upsertNotificationPreferenceDtoChannelEnum_EMAIL;

  /// Notification channel to configure
  @BuiltValueEnumConst(wireName: r'PUSH')
  static const UpsertNotificationPreferenceDtoChannelEnum PUSH =
      _$upsertNotificationPreferenceDtoChannelEnum_PUSH;

  /// Notification channel to configure
  @BuiltValueEnumConst(wireName: r'IN_APP')
  static const UpsertNotificationPreferenceDtoChannelEnum IN_APP =
      _$upsertNotificationPreferenceDtoChannelEnum_IN_APP;

  static Serializer<UpsertNotificationPreferenceDtoChannelEnum>
      get serializer => _$upsertNotificationPreferenceDtoChannelEnumSerializer;

  const UpsertNotificationPreferenceDtoChannelEnum._(String name) : super(name);

  static BuiltSet<UpsertNotificationPreferenceDtoChannelEnum> get values =>
      _$upsertNotificationPreferenceDtoChannelEnumValues;
  static UpsertNotificationPreferenceDtoChannelEnum valueOf(String name) =>
      _$upsertNotificationPreferenceDtoChannelEnumValueOf(name);
}
