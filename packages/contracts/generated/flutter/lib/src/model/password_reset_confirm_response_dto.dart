...
/// * [passwordReset]
@BuiltValue()
abstract class PasswordResetConfirmResponseDto
    implements
        Built<PasswordResetConfirmResponseDto,
  ...
  factory PasswordResetConfirmResponseDto(
          [void updates(PasswordResetConfirmResponseDtoBuilder b)]) =
      _$PasswordResetConfirmResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PasswordResetConfirmResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PasswordResetConfirmResponseDto> get serializer =>
      _$PasswordResetConfirmResponseDtoSerializer();
}

class _$PasswordResetConfirmResponseDtoSerializer
    implements PrimitiveSerializer<PasswordResetConfirmResponseDto> {
  @override
