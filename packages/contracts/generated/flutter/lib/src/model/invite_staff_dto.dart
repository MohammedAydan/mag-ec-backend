...
@BuiltValue()
abstract class InviteStaffDto
    implements Built<InviteStaffDto, InviteStaffDtoBuilder> {
  ...
  factory InviteStaffDto([void updates(InviteStaffDtoBuilder b)]) =
      _$InviteStaffDto;
  ...
  static Serializer<InviteStaffDto> get serializer =>
      _$InviteStaffDtoSerializer();
}

class _$InviteStaffDtoSerializer
    implements PrimitiveSerializer<InviteStaffDto> {
  @override
