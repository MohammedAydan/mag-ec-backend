...
/// * [colorHex]
@BuiltValue()
abstract class CatalogVariantOptionSummaryDto
    implements
        Built<CatalogVariantOptionSummaryDto,
  ...
  factory CatalogVariantOptionSummaryDto(
          [void updates(CatalogVariantOptionSummaryDtoBuilder b)]) =
      _$CatalogVariantOptionSummaryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogVariantOptionSummaryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogVariantOptionSummaryDto> get serializer =>
      _$CatalogVariantOptionSummaryDtoSerializer();
}

class _$CatalogVariantOptionSummaryDtoSerializer
    implements PrimitiveSerializer<CatalogVariantOptionSummaryDto> {
  @override
