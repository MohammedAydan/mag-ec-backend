...
/// * [brand]
@BuiltValue()
abstract class CatalogProductSummaryDto
    implements
        Built<CatalogProductSummaryDto, CatalogProductSummaryDtoBuilder> {
  ...
  factory CatalogProductSummaryDto(
          [void updates(CatalogProductSummaryDtoBuilder b)]) =
      _$CatalogProductSummaryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogProductSummaryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogProductSummaryDto> get serializer =>
      _$CatalogProductSummaryDtoSerializer();
}

class _$CatalogProductSummaryDtoSerializer
    implements PrimitiveSerializer<CatalogProductSummaryDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.categories,
      specifiedType:
          const FullType(BuiltList, [FullType(CatalogLocalizedReferenceDto)]),
    );
    yield r'collections';
    yield serializers.serialize(
      object.collections,
    ...
    yield serializers.serialize(
      object.media,
      specifiedType:
          const FullType(BuiltList, [FullType(CatalogMediaSummaryDto)]),
    );
    yield r'variants';
    yield serializers.serialize(
      object.variants,
      specifiedType:
          const FullType(BuiltList, [FullType(CatalogVariantSummaryDto)]),
    );
    if (object.name != null) {
      yield r'name';
      yield serializers.serialize(
      ...
      switch (key) {
        ...
        case r'categories':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(CatalogLocalizedReferenceDto)]),
        ...
        case r'brand':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType.nullable(CatalogLocalizedReferenceDto),
          ) as CatalogLocalizedReferenceDto?;
          if (valueDes == null) continue;
