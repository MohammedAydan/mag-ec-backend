...
@BuiltValue()
abstract class UpdateStoreCurrencyDto
    implements Built<UpdateStoreCurrencyDto, UpdateStoreCurrencyDtoBuilder> {
  ...
  factory UpdateStoreCurrencyDto(
          [void updates(UpdateStoreCurrencyDtoBuilder b)]) =
      _$UpdateStoreCurrencyDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateStoreCurrencyDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateStoreCurrencyDto> get serializer =>
      _$UpdateStoreCurrencyDtoSerializer();
}

class _$UpdateStoreCurrencyDtoSerializer
    implements PrimitiveSerializer<UpdateStoreCurrencyDto> {
  @override
