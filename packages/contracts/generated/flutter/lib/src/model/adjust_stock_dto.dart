...
@BuiltValue()
abstract class AdjustStockDto
    implements Built<AdjustStockDto, AdjustStockDtoBuilder> {
  ...
  factory AdjustStockDto([void updates(AdjustStockDtoBuilder b)]) =
      _$AdjustStockDto;
  ...
  static Serializer<AdjustStockDto> get serializer =>
      _$AdjustStockDtoSerializer();
}

class _$AdjustStockDtoSerializer
    implements PrimitiveSerializer<AdjustStockDto> {
  @override
...
class AdjustStockDtoTypeEnum extends EnumClass {
  ...
  static const AdjustStockDtoTypeEnum RECEIPT =
      _$adjustStockDtoTypeEnum_RECEIPT;

  /// Movement type
  @BuiltValueEnumConst(wireName: r'ADJUSTMENT')
  static const AdjustStockDtoTypeEnum ADJUSTMENT =
  ...
  static const AdjustStockDtoTypeEnum RETURN_RESTOCK =
  ...
  static Serializer<AdjustStockDtoTypeEnum> get serializer =>
      _$adjustStockDtoTypeEnumSerializer;

  const AdjustStockDtoTypeEnum._(String name) : super(name);

  static BuiltSet<AdjustStockDtoTypeEnum> get values =>
      _$adjustStockDtoTypeEnumValues;
  static AdjustStockDtoTypeEnum valueOf(String name) =>
      _$adjustStockDtoTypeEnumValueOf(name);
}
