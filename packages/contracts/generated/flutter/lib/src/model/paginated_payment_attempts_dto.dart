...
/// * [nextCursor]
@BuiltValue()
abstract class PaginatedPaymentAttemptsDto
    implements
        Built<PaginatedPaymentAttemptsDto, PaginatedPaymentAttemptsDtoBuilder> {
  ...
  factory PaginatedPaymentAttemptsDto(
          [void updates(PaginatedPaymentAttemptsDtoBuilder b)]) =
      _$PaginatedPaymentAttemptsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedPaymentAttemptsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedPaymentAttemptsDto> get serializer =>
      _$PaginatedPaymentAttemptsDtoSerializer();
}

class _$PaginatedPaymentAttemptsDtoSerializer
    implements PrimitiveSerializer<PaginatedPaymentAttemptsDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(PaymentAttemptResponseDto)]),
    );
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(PaymentAttemptResponseDto)]),
