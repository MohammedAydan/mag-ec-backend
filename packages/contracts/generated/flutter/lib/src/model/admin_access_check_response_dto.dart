...
/// * [allowed]
@BuiltValue()
abstract class AdminAccessCheckResponseDto
    implements
        Built<AdminAccessCheckResponseDto, AdminAccessCheckResponseDtoBuilder> {
  @BuiltValueField(wireName: r'allowed')
  bool get allowed;

  AdminAccessCheckResponseDto._();

  factory AdminAccessCheckResponseDto(
          [void updates(AdminAccessCheckResponseDtoBuilder b)]) =
      _$AdminAccessCheckResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminAccessCheckResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminAccessCheckResponseDto> get serializer =>
      _$AdminAccessCheckResponseDtoSerializer();
}

class _$AdminAccessCheckResponseDtoSerializer
    implements PrimitiveSerializer<AdminAccessCheckResponseDto> {
  @override
