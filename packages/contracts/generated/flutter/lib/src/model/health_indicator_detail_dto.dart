...
/// * [redisRequired]
@BuiltValue()
abstract class HealthIndicatorDetailDto
    implements
        Built<HealthIndicatorDetailDto, HealthIndicatorDetailDtoBuilder> {
  ...
  factory HealthIndicatorDetailDto(
          [void updates(HealthIndicatorDetailDtoBuilder b)]) =
      _$HealthIndicatorDetailDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HealthIndicatorDetailDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HealthIndicatorDetailDto> get serializer =>
      _$HealthIndicatorDetailDtoSerializer();
}

class _$HealthIndicatorDetailDtoSerializer
    implements PrimitiveSerializer<HealthIndicatorDetailDto> {
  @override
