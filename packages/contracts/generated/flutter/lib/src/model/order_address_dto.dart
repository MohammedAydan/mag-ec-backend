...
/// * [company]
@BuiltValue()
abstract class OrderAddressDto
    implements Built<OrderAddressDto, OrderAddressDtoBuilder> {
  ...
  factory OrderAddressDto([void updates(OrderAddressDtoBuilder b)]) =
      _$OrderAddressDto;
  ...
  static Serializer<OrderAddressDto> get serializer =>
      _$OrderAddressDtoSerializer();
}

class _$OrderAddressDtoSerializer
    implements PrimitiveSerializer<OrderAddressDto> {
  @override
