...
/// * [variantName]
@BuiltValue()
abstract class FulfillmentItemDto
    implements Built<FulfillmentItemDto, FulfillmentItemDtoBuilder> {
  ...
  factory FulfillmentItemDto([void updates(FulfillmentItemDtoBuilder b)]) =
      _$FulfillmentItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FulfillmentItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FulfillmentItemDto> get serializer =>
      _$FulfillmentItemDtoSerializer();
}

class _$FulfillmentItemDtoSerializer
    implements PrimitiveSerializer<FulfillmentItemDto> {
  @override
