...
@BuiltValue()
abstract class UpsertShippingMethodDto
    implements Built<UpsertShippingMethodDto, UpsertShippingMethodDtoBuilder> {
  ...
  factory UpsertShippingMethodDto(
          [void updates(UpsertShippingMethodDtoBuilder b)]) =
      _$UpsertShippingMethodDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertShippingMethodDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertShippingMethodDto> get serializer =>
      _$UpsertShippingMethodDtoSerializer();
}

class _$UpsertShippingMethodDtoSerializer
    implements PrimitiveSerializer<UpsertShippingMethodDto> {
  @override
...
class UpsertShippingMethodDtoRateTypeEnum extends EnumClass {
  ...
  static const UpsertShippingMethodDtoRateTypeEnum FLAT =
      _$upsertShippingMethodDtoRateTypeEnum_FLAT;

  /// Rate calculation type: FLAT or PERCENTAGE_OF_SUBTOTAL
  @BuiltValueEnumConst(wireName: r'PERCENTAGE_OF_SUBTOTAL')
  static const UpsertShippingMethodDtoRateTypeEnum PERCENTAGE_OF_SUBTOTAL =
      _$upsertShippingMethodDtoRateTypeEnum_PERCENTAGE_OF_SUBTOTAL;

  static Serializer<UpsertShippingMethodDtoRateTypeEnum> get serializer =>
      _$upsertShippingMethodDtoRateTypeEnumSerializer;

  const UpsertShippingMethodDtoRateTypeEnum._(String name) : super(name);

  static BuiltSet<UpsertShippingMethodDtoRateTypeEnum> get values =>
      _$upsertShippingMethodDtoRateTypeEnumValues;
  static UpsertShippingMethodDtoRateTypeEnum valueOf(String name) =>
      _$upsertShippingMethodDtoRateTypeEnumValueOf(name);
}
