...
@BuiltValue()
abstract class UpdateAdminRolePermissionsDto
    implements
        Built<UpdateAdminRolePermissionsDto,
  ...
  factory UpdateAdminRolePermissionsDto(
          [void updates(UpdateAdminRolePermissionsDtoBuilder b)]) =
      _$UpdateAdminRolePermissionsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateAdminRolePermissionsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateAdminRolePermissionsDto> get serializer =>
      _$UpdateAdminRolePermissionsDtoSerializer();
}

class _$UpdateAdminRolePermissionsDtoSerializer
    implements PrimitiveSerializer<UpdateAdminRolePermissionsDto> {
  @override
