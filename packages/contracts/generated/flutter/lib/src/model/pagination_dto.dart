...
abstract class PaginationDto
    implements Built<PaginationDto, PaginationDtoBuilder> {
  ...
  factory PaginationDto([void updates(PaginationDtoBuilder b)]) =
      _$PaginationDto;
  ...
  static Serializer<PaginationDto> get serializer =>
      _$PaginationDtoSerializer();
}
