...
/// * [itemCount]
@BuiltValue()
abstract class WishlistResponseDto
    implements Built<WishlistResponseDto, WishlistResponseDtoBuilder> {
  ...
  factory WishlistResponseDto([void updates(WishlistResponseDtoBuilder b)]) =
      _$WishlistResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WishlistResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WishlistResponseDto> get serializer =>
      _$WishlistResponseDtoSerializer();
}

class _$WishlistResponseDtoSerializer
    implements PrimitiveSerializer<WishlistResponseDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(WishlistItemResponseDto)]),
    );
