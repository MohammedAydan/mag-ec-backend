...
@BuiltValue()
abstract class UpdateStaffRolesDto
    implements Built<UpdateStaffRolesDto, UpdateStaffRolesDtoBuilder> {
  ...
  factory UpdateStaffRolesDto([void updates(UpdateStaffRolesDtoBuilder b)]) =
      _$UpdateStaffRolesDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateStaffRolesDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateStaffRolesDto> get serializer =>
      _$UpdateStaffRolesDtoSerializer();
}

class _$UpdateStaffRolesDtoSerializer
    implements PrimitiveSerializer<UpdateStaffRolesDto> {
  @override
