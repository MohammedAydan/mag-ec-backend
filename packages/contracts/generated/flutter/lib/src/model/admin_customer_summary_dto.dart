...
/// * [lastLoginAt]
@BuiltValue()
abstract class AdminCustomerSummaryDto
    implements Built<AdminCustomerSummaryDto, AdminCustomerSummaryDtoBuilder> {
  ...
  factory AdminCustomerSummaryDto(
          [void updates(AdminCustomerSummaryDtoBuilder b)]) =
      _$AdminCustomerSummaryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCustomerSummaryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCustomerSummaryDto> get serializer =>
      _$AdminCustomerSummaryDtoSerializer();
}

class _$AdminCustomerSummaryDtoSerializer
    implements PrimitiveSerializer<AdminCustomerSummaryDto> {
  @override
