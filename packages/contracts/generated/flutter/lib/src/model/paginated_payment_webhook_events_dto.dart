...
/// * [nextCursor]
@BuiltValue()
abstract class PaginatedPaymentWebhookEventsDto
    implements
        Built<PaginatedPaymentWebhookEventsDto,
  ...
  factory PaginatedPaymentWebhookEventsDto(
          [void updates(PaginatedPaymentWebhookEventsDtoBuilder b)]) =
      _$PaginatedPaymentWebhookEventsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedPaymentWebhookEventsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedPaymentWebhookEventsDto> get serializer =>
      _$PaginatedPaymentWebhookEventsDtoSerializer();
}

class _$PaginatedPaymentWebhookEventsDtoSerializer
    implements PrimitiveSerializer<PaginatedPaymentWebhookEventsDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(PaymentWebhookEventResponseDto)]),
    );
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(PaymentWebhookEventResponseDto)]),
