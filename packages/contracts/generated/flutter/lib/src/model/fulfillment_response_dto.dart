...
/// * [cancelledAt]
@BuiltValue()
abstract class FulfillmentResponseDto
    implements Built<FulfillmentResponseDto, FulfillmentResponseDtoBuilder> {
  ...
  factory FulfillmentResponseDto(
          [void updates(FulfillmentResponseDtoBuilder b)]) =
      _$FulfillmentResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FulfillmentResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FulfillmentResponseDto> get serializer =>
      _$FulfillmentResponseDtoSerializer();
}

class _$FulfillmentResponseDtoSerializer
    implements PrimitiveSerializer<FulfillmentResponseDto> {
  @override
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(BuiltList, [FullType(FulfillmentItemDto)]),
