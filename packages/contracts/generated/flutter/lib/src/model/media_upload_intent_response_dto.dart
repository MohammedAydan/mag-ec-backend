...
/// * [headers]
@BuiltValue()
abstract class MediaUploadIntentResponseDto
    implements
        Built<MediaUploadIntentResponseDto,
  ...
  factory MediaUploadIntentResponseDto(
          [void updates(MediaUploadIntentResponseDtoBuilder b)]) =
      _$MediaUploadIntentResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MediaUploadIntentResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MediaUploadIntentResponseDto> get serializer =>
      _$MediaUploadIntentResponseDtoSerializer();
}

class _$MediaUploadIntentResponseDtoSerializer
    implements PrimitiveSerializer<MediaUploadIntentResponseDto> {
  @override
