...
/// * [lineSubtotalAmount]
@BuiltValue()
abstract class TopProductSumDto
    implements Built<TopProductSumDto, TopProductSumDtoBuilder> {
  ...
  factory TopProductSumDto([void updates(TopProductSumDtoBuilder b)]) =
      _$TopProductSumDto;
  ...
  static Serializer<TopProductSumDto> get serializer =>
      _$TopProductSumDtoSerializer();
}

class _$TopProductSumDtoSerializer
    implements PrimitiveSerializer<TopProductSumDto> {
  @override
