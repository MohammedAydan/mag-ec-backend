...
/// * [translations]
@BuiltValue()
abstract class AdminCatalogCollectionDto
    implements
        Built<AdminCatalogCollectionDto, AdminCatalogCollectionDtoBuilder> {
  ...
  factory AdminCatalogCollectionDto(
          [void updates(AdminCatalogCollectionDtoBuilder b)]) =
      _$AdminCatalogCollectionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogCollectionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogCollectionDto> get serializer =>
      _$AdminCatalogCollectionDtoSerializer();
}

class _$AdminCatalogCollectionDtoSerializer
    implements PrimitiveSerializer<AdminCatalogCollectionDto> {
  @override
