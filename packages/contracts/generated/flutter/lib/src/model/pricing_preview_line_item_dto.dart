...
/// * [unitSaleAmount]
@BuiltValue()
abstract class PricingPreviewLineItemDto
    implements
        Built<PricingPreviewLineItemDto, PricingPreviewLineItemDtoBuilder> {
  ...
  factory PricingPreviewLineItemDto(
          [void updates(PricingPreviewLineItemDtoBuilder b)]) =
      _$PricingPreviewLineItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PricingPreviewLineItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PricingPreviewLineItemDto> get serializer =>
      _$PricingPreviewLineItemDtoSerializer();
}

class _$PricingPreviewLineItemDtoSerializer
    implements PrimitiveSerializer<PricingPreviewLineItemDto> {
  @override
