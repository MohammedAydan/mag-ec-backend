...
/// * [discountAmount]
@BuiltValue()
abstract class PromotionPerformanceSumDto
    implements
        Built<PromotionPerformanceSumDto, PromotionPerformanceSumDtoBuilder> {
  @BuiltValueField(wireName: r'discountAmount')
  num? get discountAmount;

  PromotionPerformanceSumDto._();

  factory PromotionPerformanceSumDto(
          [void updates(PromotionPerformanceSumDtoBuilder b)]) =
      _$PromotionPerformanceSumDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PromotionPerformanceSumDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PromotionPerformanceSumDto> get serializer =>
      _$PromotionPerformanceSumDtoSerializer();
}

class _$PromotionPerformanceSumDtoSerializer
    implements PrimitiveSerializer<PromotionPerformanceSumDto> {
  @override
