...
/// * [archivedAt]
@BuiltValue()
abstract class CatalogStatusResponseDto
    implements
        Built<CatalogStatusResponseDto, CatalogStatusResponseDtoBuilder> {
  ...
  factory CatalogStatusResponseDto(
          [void updates(CatalogStatusResponseDtoBuilder b)]) =
      _$CatalogStatusResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogStatusResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogStatusResponseDto> get serializer =>
      _$CatalogStatusResponseDtoSerializer();
}

class _$CatalogStatusResponseDtoSerializer
    implements PrimitiveSerializer<CatalogStatusResponseDto> {
  @override
