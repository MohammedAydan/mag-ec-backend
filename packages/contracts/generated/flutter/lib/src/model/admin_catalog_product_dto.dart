...
/// * [media]
@BuiltValue()
abstract class AdminCatalogProductDto
    implements Built<AdminCatalogProductDto, AdminCatalogProductDtoBuilder> {
  ...
  factory AdminCatalogProductDto(
          [void updates(AdminCatalogProductDtoBuilder b)]) =
      _$AdminCatalogProductDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogProductDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogProductDto> get serializer =>
      _$AdminCatalogProductDtoSerializer();
}

class _$AdminCatalogProductDtoSerializer
    implements PrimitiveSerializer<AdminCatalogProductDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.variants != null) {
      ...
      yield serializers.serialize(
        object.variants,
        specifiedType:
            const FullType(BuiltList, [FullType(AdminCatalogVariantDto)]),
      );
    }
    if (object.categoryLinks != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType:
            const FullType(BuiltList, [FullType(AdminCatalogRelationLinkDto)]),
      );
    }
    ...
    if (object.media != null) {
      ...
      yield serializers.serialize(
        object.media,
        specifiedType:
            const FullType(BuiltList, [FullType(AdminCatalogMediaDto)]),
      );
    }
  }
      ...
      switch (key) {
        ...
        case r'categoryLinks':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(
                BuiltList, [FullType(AdminCatalogRelationLinkDto)]),
