...
/// * [nextCursor]
@BuiltValue()
abstract class PaginatedReportExportsDto
    implements
        Built<PaginatedReportExportsDto, PaginatedReportExportsDtoBuilder> {
  ...
  factory PaginatedReportExportsDto(
          [void updates(PaginatedReportExportsDtoBuilder b)]) =
      _$PaginatedReportExportsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedReportExportsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedReportExportsDto> get serializer =>
      _$PaginatedReportExportsDtoSerializer();
}

class _$PaginatedReportExportsDtoSerializer
    implements PrimitiveSerializer<PaginatedReportExportsDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType:
          const FullType(BuiltList, [FullType(ReportExportResponseDto)]),
    );
