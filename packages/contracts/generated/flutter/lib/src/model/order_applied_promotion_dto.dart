...
/// * [couponCode]
@BuiltValue()
abstract class OrderAppliedPromotionDto
    implements
        Built<OrderAppliedPromotionDto, OrderAppliedPromotionDtoBuilder> {
  ...
  factory OrderAppliedPromotionDto(
          [void updates(OrderAppliedPromotionDtoBuilder b)]) =
      _$OrderAppliedPromotionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderAppliedPromotionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderAppliedPromotionDto> get serializer =>
      _$OrderAppliedPromotionDtoSerializer();
}

class _$OrderAppliedPromotionDtoSerializer
    implements PrimitiveSerializer<OrderAppliedPromotionDto> {
  @override
