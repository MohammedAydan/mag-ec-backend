...
/// * [updatedAt]
@BuiltValue()
abstract class ShippingZoneResponseDto
    implements Built<ShippingZoneResponseDto, ShippingZoneResponseDtoBuilder> {
  ...
  factory ShippingZoneResponseDto(
          [void updates(ShippingZoneResponseDtoBuilder b)]) =
      _$ShippingZoneResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ShippingZoneResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ShippingZoneResponseDto> get serializer =>
      _$ShippingZoneResponseDtoSerializer();
}

class _$ShippingZoneResponseDtoSerializer
    implements PrimitiveSerializer<ShippingZoneResponseDto> {
  @override
