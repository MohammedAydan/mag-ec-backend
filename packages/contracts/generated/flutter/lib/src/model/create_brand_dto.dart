...
/// * [translations]
@BuiltValue()
abstract class CreateBrandDto
    implements Built<CreateBrandDto, CreateBrandDtoBuilder> {
  ...
  factory CreateBrandDto([void updates(CreateBrandDtoBuilder b)]) =
      _$CreateBrandDto;
  ...
  static Serializer<CreateBrandDto> get serializer =>
      _$CreateBrandDtoSerializer();
}

class _$CreateBrandDtoSerializer
    implements PrimitiveSerializer<CreateBrandDto> {
  @override
