...
/// * [parentId]
@BuiltValue()
abstract class AdminCatalogCategoryDto
    implements Built<AdminCatalogCategoryDto, AdminCatalogCategoryDtoBuilder> {
  ...
  factory AdminCatalogCategoryDto(
          [void updates(AdminCatalogCategoryDtoBuilder b)]) =
      _$AdminCatalogCategoryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogCategoryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogCategoryDto> get serializer =>
      _$AdminCatalogCategoryDtoSerializer();
}

class _$AdminCatalogCategoryDtoSerializer
    implements PrimitiveSerializer<AdminCatalogCategoryDto> {
  @override
