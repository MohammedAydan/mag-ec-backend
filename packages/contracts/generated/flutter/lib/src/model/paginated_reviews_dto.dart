...
/// * [nextCursor]
@BuiltValue()
abstract class PaginatedReviewsDto
    implements Built<PaginatedReviewsDto, PaginatedReviewsDtoBuilder> {
  ...
  factory PaginatedReviewsDto([void updates(PaginatedReviewsDtoBuilder b)]) =
      _$PaginatedReviewsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedReviewsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedReviewsDto> get serializer =>
      _$PaginatedReviewsDtoSerializer();
}

class _$PaginatedReviewsDtoSerializer
    implements PrimitiveSerializer<PaginatedReviewsDto> {
  @override
      ...
      switch (key) {
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(BuiltList, [FullType(ReviewResponseDto)]),
