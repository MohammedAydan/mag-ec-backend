...
/// * [estimatedMaxDays]
@BuiltValue()
abstract class OrderShippingMethodDetailsDto
    implements
        Built<OrderShippingMethodDetailsDto,
  ...
  factory OrderShippingMethodDetailsDto(
          [void updates(OrderShippingMethodDetailsDtoBuilder b)]) =
      _$OrderShippingMethodDetailsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderShippingMethodDetailsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderShippingMethodDetailsDto> get serializer =>
      _$OrderShippingMethodDetailsDtoSerializer();
}

class _$OrderShippingMethodDetailsDtoSerializer
    implements PrimitiveSerializer<OrderShippingMethodDetailsDto> {
  @override
