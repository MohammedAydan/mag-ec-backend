...
@BuiltValue()
abstract class UpdatePricingBehaviorDto
    implements
        Built<UpdatePricingBehaviorDto, UpdatePricingBehaviorDtoBuilder> {
  ...
  factory UpdatePricingBehaviorDto(
          [void updates(UpdatePricingBehaviorDtoBuilder b)]) =
      _$UpdatePricingBehaviorDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdatePricingBehaviorDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdatePricingBehaviorDto> get serializer =>
      _$UpdatePricingBehaviorDtoSerializer();
}

class _$UpdatePricingBehaviorDtoSerializer
    implements PrimitiveSerializer<UpdatePricingBehaviorDto> {
  @override
