...
@BuiltValue()
abstract class ReceiveReturnRequestItemDto
    implements
        Built<ReceiveReturnRequestItemDto, ReceiveReturnRequestItemDtoBuilder> {
  ...
  factory ReceiveReturnRequestItemDto(
          [void updates(ReceiveReturnRequestItemDtoBuilder b)]) =
      _$ReceiveReturnRequestItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReceiveReturnRequestItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReceiveReturnRequestItemDto> get serializer =>
      _$ReceiveReturnRequestItemDtoSerializer();
}

class _$ReceiveReturnRequestItemDtoSerializer
    implements PrimitiveSerializer<ReceiveReturnRequestItemDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      ...
      specifiedType:
          const FullType(ReceiveReturnRequestItemDtoFinalDispositionEnum),
    );
...
class ReceiveReturnRequestItemDtoFinalDispositionEnum extends EnumClass {
  ...
  static const ReceiveReturnRequestItemDtoFinalDispositionEnum RESTOCK =
      _$receiveReturnRequestItemDtoFinalDispositionEnum_RESTOCK;

  /// Final disposition after inspection
  @BuiltValueEnumConst(wireName: r'INSPECT')
  static const ReceiveReturnRequestItemDtoFinalDispositionEnum INSPECT =
      _$receiveReturnRequestItemDtoFinalDispositionEnum_INSPECT;

  /// Final disposition after inspection
  @BuiltValueEnumConst(wireName: r'DISCARD')
  static const ReceiveReturnRequestItemDtoFinalDispositionEnum DISCARD =
      _$receiveReturnRequestItemDtoFinalDispositionEnum_DISCARD;

  static Serializer<ReceiveReturnRequestItemDtoFinalDispositionEnum>
      get serializer =>
          _$receiveReturnRequestItemDtoFinalDispositionEnumSerializer;

  const ReceiveReturnRequestItemDtoFinalDispositionEnum._(String name)
      : super(name);

  static BuiltSet<ReceiveReturnRequestItemDtoFinalDispositionEnum> get values =>
      _$receiveReturnRequestItemDtoFinalDispositionEnumValues;
  static ReceiveReturnRequestItemDtoFinalDispositionEnum valueOf(String name) =>
      _$receiveReturnRequestItemDtoFinalDispositionEnumValueOf(name);
}
