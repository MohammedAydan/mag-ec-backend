...
/// * [metaDescription]
@BuiltValue()
abstract class AdminCatalogTranslationDto
    implements
        Built<AdminCatalogTranslationDto, AdminCatalogTranslationDtoBuilder> {
  ...
  factory AdminCatalogTranslationDto(
          [void updates(AdminCatalogTranslationDtoBuilder b)]) =
      _$AdminCatalogTranslationDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogTranslationDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogTranslationDto> get serializer =>
      _$AdminCatalogTranslationDtoSerializer();
}

class _$AdminCatalogTranslationDtoSerializer
    implements PrimitiveSerializer<AdminCatalogTranslationDto> {
  @override
