...
/// * [estimatedMaxDays]
@BuiltValue()
abstract class ShippingMethodResponseDto
    implements
        Built<ShippingMethodResponseDto, ShippingMethodResponseDtoBuilder> {
  ...
  factory ShippingMethodResponseDto(
          [void updates(ShippingMethodResponseDtoBuilder b)]) =
      _$ShippingMethodResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ShippingMethodResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ShippingMethodResponseDto> get serializer =>
      _$ShippingMethodResponseDtoSerializer();
}

class _$ShippingMethodResponseDtoSerializer
    implements PrimitiveSerializer<ShippingMethodResponseDto> {
  @override
