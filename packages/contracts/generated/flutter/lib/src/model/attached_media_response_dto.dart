...
/// * [attachedAt]
@BuiltValue()
abstract class AttachedMediaResponseDto
    implements
        Built<AttachedMediaResponseDto, AttachedMediaResponseDtoBuilder> {
  ...
  factory AttachedMediaResponseDto(
          [void updates(AttachedMediaResponseDtoBuilder b)]) =
      _$AttachedMediaResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AttachedMediaResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AttachedMediaResponseDto> get serializer =>
      _$AttachedMediaResponseDtoSerializer();
}

class _$AttachedMediaResponseDtoSerializer
    implements PrimitiveSerializer<AttachedMediaResponseDto> {
  @override
