...
/// * [failedAt]
@BuiltValue()
abstract class PaymentAttemptResponseDto
    implements
        Built<PaymentAttemptResponseDto, PaymentAttemptResponseDtoBuilder> {
  ...
  factory PaymentAttemptResponseDto(
          [void updates(PaymentAttemptResponseDtoBuilder b)]) =
      _$PaymentAttemptResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentAttemptResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentAttemptResponseDto> get serializer =>
      _$PaymentAttemptResponseDtoSerializer();
}

class _$PaymentAttemptResponseDtoSerializer
    implements PrimitiveSerializer<PaymentAttemptResponseDto> {
  @override
