...
/// * [slug]
@BuiltValue()
abstract class CatalogLocalizedReferenceDto
    implements
        Built<CatalogLocalizedReferenceDto,
  ...
  factory CatalogLocalizedReferenceDto(
          [void updates(CatalogLocalizedReferenceDtoBuilder b)]) =
      _$CatalogLocalizedReferenceDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogLocalizedReferenceDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogLocalizedReferenceDto> get serializer =>
      _$CatalogLocalizedReferenceDtoSerializer();
}

class _$CatalogLocalizedReferenceDtoSerializer
    implements PrimitiveSerializer<CatalogLocalizedReferenceDto> {
  @override
