...
/// * [title]
@BuiltValue()
abstract class AttachedMediaTranslationDto
    implements
        Built<AttachedMediaTranslationDto, AttachedMediaTranslationDtoBuilder> {
  ...
  factory AttachedMediaTranslationDto(
          [void updates(AttachedMediaTranslationDtoBuilder b)]) =
      _$AttachedMediaTranslationDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AttachedMediaTranslationDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AttachedMediaTranslationDto> get serializer =>
      _$AttachedMediaTranslationDtoSerializer();
}

class _$AttachedMediaTranslationDtoSerializer
    implements PrimitiveSerializer<AttachedMediaTranslationDto> {
  @override
