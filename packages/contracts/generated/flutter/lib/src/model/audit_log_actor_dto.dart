...
/// * [status]
@BuiltValue()
abstract class AuditLogActorDto
    implements Built<AuditLogActorDto, AuditLogActorDtoBuilder> {
  ...
  factory AuditLogActorDto([void updates(AuditLogActorDtoBuilder b)]) =
      _$AuditLogActorDto;
  ...
  static Serializer<AuditLogActorDto> get serializer =>
      _$AuditLogActorDtoSerializer();
}

class _$AuditLogActorDtoSerializer
    implements PrimitiveSerializer<AuditLogActorDto> {
  @override
