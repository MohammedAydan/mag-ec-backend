...
@BuiltValue()
abstract class CreateReportExportDto
    implements Built<CreateReportExportDto, CreateReportExportDtoBuilder> {
  ...
  factory CreateReportExportDto(
      [void updates(CreateReportExportDtoBuilder b)]) = _$CreateReportExportDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateReportExportDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateReportExportDto> get serializer =>
      _$CreateReportExportDtoSerializer();
}

class _$CreateReportExportDtoSerializer
    implements PrimitiveSerializer<CreateReportExportDto> {
  @override
  final Iterable<Type> types = const [
    CreateReportExportDto,
    _$CreateReportExportDto
  ];
...
class CreateReportExportDtoReportTypeEnum extends EnumClass {
  ...
  static const CreateReportExportDtoReportTypeEnum salesSummary =
      _$createReportExportDtoReportTypeEnum_salesSummary;

  /// Report type identifier (sales_summary, top_products, promotion_performance, inventory_kpis)
  @BuiltValueEnumConst(wireName: r'top_products')
  static const CreateReportExportDtoReportTypeEnum topProducts =
      _$createReportExportDtoReportTypeEnum_topProducts;

  /// Report type identifier (sales_summary, top_products, promotion_performance, inventory_kpis)
  @BuiltValueEnumConst(wireName: r'promotion_performance')
  static const CreateReportExportDtoReportTypeEnum promotionPerformance =
      _$createReportExportDtoReportTypeEnum_promotionPerformance;

  /// Report type identifier (sales_summary, top_products, promotion_performance, inventory_kpis)
  @BuiltValueEnumConst(wireName: r'inventory_kpis')
  static const CreateReportExportDtoReportTypeEnum inventoryKpis =
      _$createReportExportDtoReportTypeEnum_inventoryKpis;

  static Serializer<CreateReportExportDtoReportTypeEnum> get serializer =>
      _$createReportExportDtoReportTypeEnumSerializer;

  const CreateReportExportDtoReportTypeEnum._(String name) : super(name);

  static BuiltSet<CreateReportExportDtoReportTypeEnum> get values =>
      _$createReportExportDtoReportTypeEnumValues;
  static CreateReportExportDtoReportTypeEnum valueOf(String name) =>
      _$createReportExportDtoReportTypeEnumValueOf(name);
}
