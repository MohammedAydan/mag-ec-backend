...
/// * [translations]
@BuiltValue()
abstract class AdminCatalogBrandDto
    implements Built<AdminCatalogBrandDto, AdminCatalogBrandDtoBuilder> {
  ...
  factory AdminCatalogBrandDto([void updates(AdminCatalogBrandDtoBuilder b)]) =
      _$AdminCatalogBrandDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogBrandDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogBrandDto> get serializer =>
      _$AdminCatalogBrandDtoSerializer();
}

class _$AdminCatalogBrandDtoSerializer
    implements PrimitiveSerializer<AdminCatalogBrandDto> {
  @override
