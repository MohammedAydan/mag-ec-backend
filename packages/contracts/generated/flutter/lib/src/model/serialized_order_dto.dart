...
part 'serialized_order_dto.g.dart';
...
/// * [paidAt]
@BuiltValue()
abstract class SerializedOrderDto
    implements Built<SerializedOrderDto, SerializedOrderDtoBuilder> {
  ...
  SerializedOrderDto._();

  factory SerializedOrderDto([void updates(SerializedOrderDtoBuilder b)]) =
      _$SerializedOrderDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SerializedOrderDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SerializedOrderDto> get serializer =>
      _$SerializedOrderDtoSerializer();
}

class _$SerializedOrderDtoSerializer
    implements PrimitiveSerializer<SerializedOrderDto> {
  @override
  final Iterable<Type> types = const [SerializedOrderDto, _$SerializedOrderDto];

  @override
  final String wireName = r'SerializedOrderDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SerializedOrderDto object, {
    ...
    yield serializers.serialize(
      ...
      specifiedType:
          const FullType(BuiltList, [FullType(OrderAppliedPromotionDto)]),
    );
    yield r'shipments';
    yield serializers.serialize(
      object.shipments,
    ...
    yield serializers.serialize(
      ...
      specifiedType:
          const FullType(BuiltList, [FullType(OrderReturnRequestDto)]),
    );
    yield r'refunds';
    yield serializers.serialize(
      object.refunds,
  ...
  void _deserializeProperties(
    ...
    required SerializedOrderDtoBuilder result,
      ...
      switch (key) {
        ...
        case r'addresses':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(BuiltList, [FullType(OrderAddressDto)]),
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(BuiltList, [FullType(OrderLineItemDto)]),
        ...
        case r'shipments':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(BuiltList, [FullType(OrderShipmentDto)]),
  ...
  @override
  SerializedOrderDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SerializedOrderDtoBuilder();
