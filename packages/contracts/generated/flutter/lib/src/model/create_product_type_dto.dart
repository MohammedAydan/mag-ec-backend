...
/// * [attributes]
@BuiltValue()
abstract class CreateProductTypeDto
    implements Built<CreateProductTypeDto, CreateProductTypeDtoBuilder> {
  ...
  factory CreateProductTypeDto([void updates(CreateProductTypeDtoBuilder b)]) =
      _$CreateProductTypeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateProductTypeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateProductTypeDto> get serializer =>
      _$CreateProductTypeDtoSerializer();
}

class _$CreateProductTypeDtoSerializer
    implements PrimitiveSerializer<CreateProductTypeDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.attributes != null) {
      ...
      yield serializers.serialize(
        object.attributes,
        specifiedType:
            const FullType(BuiltList, [FullType(ProductTypeAttributeLinkDto)]),
      );
    }
  }
        ...
        case r'attributes':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(
                BuiltList, [FullType(ProductTypeAttributeLinkDto)]),
