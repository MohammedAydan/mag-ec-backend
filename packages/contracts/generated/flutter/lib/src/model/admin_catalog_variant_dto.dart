...
/// * [price]
@BuiltValue()
abstract class AdminCatalogVariantDto
    implements Built<AdminCatalogVariantDto, AdminCatalogVariantDtoBuilder> {
  ...
  factory AdminCatalogVariantDto(
          [void updates(AdminCatalogVariantDtoBuilder b)]) =
      _$AdminCatalogVariantDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogVariantDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogVariantDto> get serializer =>
      _$AdminCatalogVariantDtoSerializer();
}

class _$AdminCatalogVariantDtoSerializer
    implements PrimitiveSerializer<AdminCatalogVariantDto> {
  @override
    ...
    if (object.optionValues != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(
            BuiltList, [FullType(AdminCatalogProductVariantOptionValueDto)]),
      );
    }
        ...
        case r'optionValues':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType(BuiltList,
                [FullType(AdminCatalogProductVariantOptionValueDto)]),
