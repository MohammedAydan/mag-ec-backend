...
/// * [position]
@BuiltValue()
abstract class CreateProductVariantDto
    implements Built<CreateProductVariantDto, CreateProductVariantDtoBuilder> {
  ...
  factory CreateProductVariantDto(
          [void updates(CreateProductVariantDtoBuilder b)]) =
      _$CreateProductVariantDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateProductVariantDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateProductVariantDto> get serializer =>
      _$CreateProductVariantDtoSerializer();
}

class _$CreateProductVariantDtoSerializer
    implements PrimitiveSerializer<CreateProductVariantDto> {
  @override
