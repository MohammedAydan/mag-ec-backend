...
/// * [quantity]
@BuiltValue()
abstract class ReviewOrderLineDto
    implements Built<ReviewOrderLineDto, ReviewOrderLineDtoBuilder> {
  ...
  factory ReviewOrderLineDto([void updates(ReviewOrderLineDtoBuilder b)]) =
      _$ReviewOrderLineDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReviewOrderLineDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReviewOrderLineDto> get serializer =>
      _$ReviewOrderLineDtoSerializer();
}

class _$ReviewOrderLineDtoSerializer
    implements PrimitiveSerializer<ReviewOrderLineDto> {
  @override
