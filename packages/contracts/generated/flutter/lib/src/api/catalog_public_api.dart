...
class CatalogPublicApi {
  ...
  Future<Response<PaginatedCatalogProductsDto>> catalogPublicBrowseProducts({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (brandSlug != null)
        r'brandSlug': encodeQueryParameter(
            _serializers, brandSlug, const FullType(String)),
      if (categorySlug != null)
        r'categorySlug': encodeQueryParameter(
            _serializers, categorySlug, const FullType(String)),
      if (collectionSlug != null)
        r'collectionSlug': encodeQueryParameter(
            _serializers, collectionSlug, const FullType(String)),
      if (tagSlug != null)
        r'tagSlug':
            encodeQueryParameter(_serializers, tagSlug, const FullType(String)),
      if (productTypeKey != null)
        r'productTypeKey': encodeQueryParameter(
            _serializers, productTypeKey, const FullType(String)),
      if (optionKeys != null)
        r'optionKeys': encodeQueryParameter(
            _serializers, optionKeys, const FullType(String)),
    };
  ...
  Future<Response<CatalogProductSummaryDto>> catalogPublicGetProductBySlug({
    ...
    final _path = r'/api/v1/catalog/products/{slug}'.replaceAll(
        '{' r'slug' '}',
