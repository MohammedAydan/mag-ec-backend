...
final int limit = 56; // int | Maximum results to return (1-100)
 ...
 **limit** | **int**| Maximum results to return (1-100) | [optional] 
...
final int limit = 56; // int | Results per page (minimum 1)
 ...
 **limit** | **int**| Results per page (minimum 1) | [optional] 
