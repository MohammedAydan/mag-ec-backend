...
`couponCode` | string
`paidAt` | string
`payment` | [CheckoutPaymentAttemptDto](CheckoutPaymentAttemptDto.md)

## Example

```typescript
import type { CheckoutPlaceOrderResponseDto } from '@mag/generated-api-client'
...
const example = {
  ...
  "paidAt": null,
  "payment": null,
} satisfies CheckoutPlaceOrderResponseDto
...
const exampleParsed = JSON.parse(exampleJSON) as CheckoutPlaceOrderResponseDto
