...
/// * [variant] 
@BuiltValue()
abstract class StockLevelResponseDto implements Built<StockLevelResponseDto, StockLevelResponseDtoBuilder> {
  ...
  factory StockLevelResponseDto([void updates(StockLevelResponseDtoBuilder b)]) = _$StockLevelResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StockLevelResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StockLevelResponseDto> get serializer => _$StockLevelResponseDtoSerializer();
}

class _$StockLevelResponseDtoSerializer implements PrimitiveSerializer<StockLevelResponseDto> {
  @override
  final Iterable<Type> types = const [StockLevelResponseDto, _$StockLevelResponseDto];
