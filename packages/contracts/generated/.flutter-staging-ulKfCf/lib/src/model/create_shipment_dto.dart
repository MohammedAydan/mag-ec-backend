...
@BuiltValue()
abstract class CreateShipmentDto implements Built<CreateShipmentDto, CreateShipmentDtoBuilder> {
  /// Shipment line items
  ...
  factory CreateShipmentDto([void updates(CreateShipmentDtoBuilder b)]) = _$CreateShipmentDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateShipmentDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateShipmentDto> get serializer => _$CreateShipmentDtoSerializer();
}

class _$CreateShipmentDtoSerializer implements PrimitiveSerializer<CreateShipmentDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(CreateShipmentItemDto)]),
    );
