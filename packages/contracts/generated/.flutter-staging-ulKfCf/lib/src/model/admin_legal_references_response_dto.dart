...
/// * [shippingPageKey] 
@BuiltValue()
abstract class AdminLegalReferencesResponseDto implements Built<AdminLegalReferencesResponseDto, AdminLegalReferencesResponseDtoBuilder> {
  ...
  factory AdminLegalReferencesResponseDto([void updates(AdminLegalReferencesResponseDtoBuilder b)]) = _$AdminLegalReferencesResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminLegalReferencesResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminLegalReferencesResponseDto> get serializer => _$AdminLegalReferencesResponseDtoSerializer();
}

class _$AdminLegalReferencesResponseDtoSerializer implements PrimitiveSerializer<AdminLegalReferencesResponseDto> {
  @override
  final Iterable<Type> types = const [AdminLegalReferencesResponseDto, _$AdminLegalReferencesResponseDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield object.termsPageKey == null ? null : serializers.serialize(
      object.termsPageKey,
      specifiedType: const FullType.nullable(String),
    );
    yield r'privacyPageKey';
    yield object.privacyPageKey == null ? null : serializers.serialize(
      object.privacyPageKey,
      specifiedType: const FullType.nullable(String),
    );
    yield r'returnsPageKey';
    yield object.returnsPageKey == null ? null : serializers.serialize(
      object.returnsPageKey,
      specifiedType: const FullType.nullable(String),
    );
    yield r'shippingPageKey';
    yield object.shippingPageKey == null ? null : serializers.serialize(
