...
@BuiltValue()
abstract class ReceiveReturnRequestDto implements Built<ReceiveReturnRequestDto, ReceiveReturnRequestDtoBuilder> {
  ...
  factory ReceiveReturnRequestDto([void updates(ReceiveReturnRequestDtoBuilder b)]) = _$ReceiveReturnRequestDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReceiveReturnRequestDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReceiveReturnRequestDto> get serializer => _$ReceiveReturnRequestDtoSerializer();
}

class _$ReceiveReturnRequestDtoSerializer implements PrimitiveSerializer<ReceiveReturnRequestDto> {
  @override
  final Iterable<Type> types = const [ReceiveReturnRequestDto, _$ReceiveReturnRequestDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(ReceiveReturnRequestItemDto)]),
    );
  }
