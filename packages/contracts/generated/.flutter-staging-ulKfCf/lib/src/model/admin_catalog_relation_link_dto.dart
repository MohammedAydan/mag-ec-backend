...
/// * [tag] 
@BuiltValue()
abstract class AdminCatalogRelationLinkDto implements Built<AdminCatalogRelationLinkDto, AdminCatalogRelationLinkDtoBuilder> {
  ...
  factory AdminCatalogRelationLinkDto([void updates(AdminCatalogRelationLinkDtoBuilder b)]) = _$AdminCatalogRelationLinkDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogRelationLinkDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogRelationLinkDto> get serializer => _$AdminCatalogRelationLinkDtoSerializer();
}

class _$AdminCatalogRelationLinkDtoSerializer implements PrimitiveSerializer<AdminCatalogRelationLinkDto> {
  @override
  final Iterable<Type> types = const [AdminCatalogRelationLinkDto, _$AdminCatalogRelationLinkDto];
