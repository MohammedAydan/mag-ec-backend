...
/// * [cancelledAt] 
@BuiltValue()
abstract class OrderShipmentDto implements Built<OrderShipmentDto, OrderShipmentDtoBuilder> {
  ...
  factory OrderShipmentDto([void updates(OrderShipmentDtoBuilder b)]) = _$OrderShipmentDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderShipmentDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderShipmentDto> get serializer => _$OrderShipmentDtoSerializer();
}

class _$OrderShipmentDtoSerializer implements PrimitiveSerializer<OrderShipmentDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(OrderShipmentItemDto)]),
    );
