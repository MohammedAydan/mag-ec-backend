...
/// * [roles] 
@BuiltValue()
abstract class StaffDetailDto implements Built<StaffDetailDto, StaffDetailDtoBuilder> {
  ...
  factory StaffDetailDto([void updates(StaffDetailDtoBuilder b)]) = _$StaffDetailDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StaffDetailDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StaffDetailDto> get serializer => _$StaffDetailDtoSerializer();
}

class _$StaffDetailDtoSerializer implements PrimitiveSerializer<StaffDetailDto> {
  @override
