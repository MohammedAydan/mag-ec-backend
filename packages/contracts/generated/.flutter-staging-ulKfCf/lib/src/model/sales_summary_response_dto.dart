...
/// * [refunds] 
@BuiltValue()
abstract class SalesSummaryResponseDto implements Built<SalesSummaryResponseDto, SalesSummaryResponseDtoBuilder> {
  ...
  factory SalesSummaryResponseDto([void updates(SalesSummaryResponseDtoBuilder b)]) = _$SalesSummaryResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalesSummaryResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalesSummaryResponseDto> get serializer => _$SalesSummaryResponseDtoSerializer();
}

class _$SalesSummaryResponseDtoSerializer implements PrimitiveSerializer<SalesSummaryResponseDto> {
  @override
  final Iterable<Type> types = const [SalesSummaryResponseDto, _$SalesSummaryResponseDto];
