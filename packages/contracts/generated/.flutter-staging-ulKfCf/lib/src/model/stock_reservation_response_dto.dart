...
/// * [user] 
@BuiltValue()
abstract class StockReservationResponseDto implements Built<StockReservationResponseDto, StockReservationResponseDtoBuilder> {
  ...
  factory StockReservationResponseDto([void updates(StockReservationResponseDtoBuilder b)]) = _$StockReservationResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StockReservationResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StockReservationResponseDto> get serializer => _$StockReservationResponseDtoSerializer();
}

class _$StockReservationResponseDtoSerializer implements PrimitiveSerializer<StockReservationResponseDto> {
  @override
  final Iterable<Type> types = const [StockReservationResponseDto, _$StockReservationResponseDto];
