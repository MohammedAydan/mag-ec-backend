...
@BuiltValue()
abstract class CheckoutAddressDto implements Built<CheckoutAddressDto, CheckoutAddressDtoBuilder> {
  ...
  factory CheckoutAddressDto([void updates(CheckoutAddressDtoBuilder b)]) = _$CheckoutAddressDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutAddressDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutAddressDto> get serializer => _$CheckoutAddressDtoSerializer();
}

class _$CheckoutAddressDtoSerializer implements PrimitiveSerializer<CheckoutAddressDto> {
  @override
