...
@BuiltValue()
abstract class AddWishlistItemDto implements Built<AddWishlistItemDto, AddWishlistItemDtoBuilder> {
  ...
  factory AddWishlistItemDto([void updates(AddWishlistItemDtoBuilder b)]) = _$AddWishlistItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AddWishlistItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AddWishlistItemDto> get serializer => _$AddWishlistItemDtoSerializer();
}

class _$AddWishlistItemDtoSerializer implements PrimitiveSerializer<AddWishlistItemDto> {
  @override
