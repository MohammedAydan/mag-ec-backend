...
/// * [sum] 
@BuiltValue()
abstract class InventoryKpisStockMetricDto implements Built<InventoryKpisStockMetricDto, InventoryKpisStockMetricDtoBuilder> {
  ...
  factory InventoryKpisStockMetricDto([void updates(InventoryKpisStockMetricDtoBuilder b)]) = _$InventoryKpisStockMetricDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InventoryKpisStockMetricDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InventoryKpisStockMetricDto> get serializer => _$InventoryKpisStockMetricDtoSerializer();
}

class _$InventoryKpisStockMetricDtoSerializer implements PrimitiveSerializer<InventoryKpisStockMetricDto> {
  @override
  final Iterable<Type> types = const [InventoryKpisStockMetricDto, _$InventoryKpisStockMetricDto];
