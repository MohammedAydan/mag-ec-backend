...
@BuiltValue()
abstract class PromotionResponseDto implements Built<PromotionResponseDto, PromotionResponseDtoBuilder> {
  ...
  factory PromotionResponseDto([void updates(PromotionResponseDtoBuilder b)]) = _$PromotionResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PromotionResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PromotionResponseDto> get serializer => _$PromotionResponseDtoSerializer();
}

class _$PromotionResponseDtoSerializer implements PrimitiveSerializer<PromotionResponseDto> {
  @override
  final Iterable<Type> types = const [PromotionResponseDto, _$PromotionResponseDto];
