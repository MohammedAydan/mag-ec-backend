...
/// * [options] 
@BuiltValue()
abstract class AdminCatalogAttributeDto implements Built<AdminCatalogAttributeDto, AdminCatalogAttributeDtoBuilder> {
  ...
  factory AdminCatalogAttributeDto([void updates(AdminCatalogAttributeDtoBuilder b)]) = _$AdminCatalogAttributeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogAttributeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogAttributeDto> get serializer => _$AdminCatalogAttributeDtoSerializer();
}

class _$AdminCatalogAttributeDtoSerializer implements PrimitiveSerializer<AdminCatalogAttributeDto> {
  @override
  final Iterable<Type> types = const [AdminCatalogAttributeDto, _$AdminCatalogAttributeDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.options,
      specifiedType: const FullType(BuiltList, [FullType(AdminCatalogAttributeOptionDto)]),
    );
  }
