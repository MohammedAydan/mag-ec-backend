...
/// * [status] 
@BuiltValue()
abstract class OrderBriefDto implements Built<OrderBriefDto, OrderBriefDtoBuilder> {
  ...
  factory OrderBriefDto([void updates(OrderBriefDtoBuilder b)]) = _$OrderBriefDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderBriefDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderBriefDto> get serializer => _$OrderBriefDtoSerializer();
}
