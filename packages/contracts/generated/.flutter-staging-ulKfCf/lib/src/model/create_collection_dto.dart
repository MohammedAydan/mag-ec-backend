...
/// * [sortOrder] 
@BuiltValue()
abstract class CreateCollectionDto implements Built<CreateCollectionDto, CreateCollectionDtoBuilder> {
  ...
  factory CreateCollectionDto([void updates(CreateCollectionDtoBuilder b)]) = _$CreateCollectionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateCollectionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateCollectionDto> get serializer => _$CreateCollectionDtoSerializer();
}

class _$CreateCollectionDtoSerializer implements PrimitiveSerializer<CreateCollectionDto> {
  @override
  final Iterable<Type> types = const [CreateCollectionDto, _$CreateCollectionDto];
