...
/// * [closedAt] 
@BuiltValue()
abstract class OrderReturnRequestDto implements Built<OrderReturnRequestDto, OrderReturnRequestDtoBuilder> {
  ...
  factory OrderReturnRequestDto([void updates(OrderReturnRequestDtoBuilder b)]) = _$OrderReturnRequestDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderReturnRequestDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderReturnRequestDto> get serializer => _$OrderReturnRequestDtoSerializer();
}

class _$OrderReturnRequestDtoSerializer implements PrimitiveSerializer<OrderReturnRequestDto> {
  @override
  final Iterable<Type> types = const [OrderReturnRequestDto, _$OrderReturnRequestDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(OrderReturnRequestItemDto)]),
    );
    yield r'refunds';
    yield serializers.serialize(
      object.refunds,
