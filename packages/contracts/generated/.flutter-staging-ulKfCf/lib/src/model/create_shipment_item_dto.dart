...
@BuiltValue()
abstract class CreateShipmentItemDto implements Built<CreateShipmentItemDto, CreateShipmentItemDtoBuilder> {
  ...
  factory CreateShipmentItemDto([void updates(CreateShipmentItemDtoBuilder b)]) = _$CreateShipmentItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateShipmentItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateShipmentItemDto> get serializer => _$CreateShipmentItemDtoSerializer();
}

class _$CreateShipmentItemDtoSerializer implements PrimitiveSerializer<CreateShipmentItemDto> {
  @override
  final Iterable<Type> types = const [CreateShipmentItemDto, _$CreateShipmentItemDto];
