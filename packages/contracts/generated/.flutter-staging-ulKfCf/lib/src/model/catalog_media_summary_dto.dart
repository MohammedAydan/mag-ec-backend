...
/// * [title] 
@BuiltValue()
abstract class CatalogMediaSummaryDto implements Built<CatalogMediaSummaryDto, CatalogMediaSummaryDtoBuilder> {
  ...
  factory CatalogMediaSummaryDto([void updates(CatalogMediaSummaryDtoBuilder b)]) = _$CatalogMediaSummaryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogMediaSummaryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogMediaSummaryDto> get serializer => _$CatalogMediaSummaryDtoSerializer();
}

class _$CatalogMediaSummaryDtoSerializer implements PrimitiveSerializer<CatalogMediaSummaryDto> {
  @override
  final Iterable<Type> types = const [CatalogMediaSummaryDto, _$CatalogMediaSummaryDto];
