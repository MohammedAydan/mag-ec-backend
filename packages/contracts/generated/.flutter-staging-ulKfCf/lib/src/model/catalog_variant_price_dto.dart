...
/// * [saleAmount] 
@BuiltValue()
abstract class CatalogVariantPriceDto implements Built<CatalogVariantPriceDto, CatalogVariantPriceDtoBuilder> {
  ...
  factory CatalogVariantPriceDto([void updates(CatalogVariantPriceDtoBuilder b)]) = _$CatalogVariantPriceDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogVariantPriceDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogVariantPriceDto> get serializer => _$CatalogVariantPriceDtoSerializer();
}

class _$CatalogVariantPriceDtoSerializer implements PrimitiveSerializer<CatalogVariantPriceDto> {
  @override
  final Iterable<Type> types = const [CatalogVariantPriceDto, _$CatalogVariantPriceDto];
