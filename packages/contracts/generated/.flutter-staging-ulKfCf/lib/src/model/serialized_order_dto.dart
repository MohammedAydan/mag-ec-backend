...
/// * [paidAt] 
@BuiltValue()
abstract class SerializedOrderDto implements Built<SerializedOrderDto, SerializedOrderDtoBuilder> {
  ...
  factory SerializedOrderDto([void updates(SerializedOrderDtoBuilder b)]) = _$SerializedOrderDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SerializedOrderDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SerializedOrderDto> get serializer => _$SerializedOrderDtoSerializer();
}

class _$SerializedOrderDtoSerializer implements PrimitiveSerializer<SerializedOrderDto> {
  @override
