...
/// * [colorHex] 
@BuiltValue()
abstract class AttributeOptionDto implements Built<AttributeOptionDto, AttributeOptionDtoBuilder> {
  ...
  factory AttributeOptionDto([void updates(AttributeOptionDtoBuilder b)]) = _$AttributeOptionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AttributeOptionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AttributeOptionDto> get serializer => _$AttributeOptionDtoSerializer();
}

class _$AttributeOptionDtoSerializer implements PrimitiveSerializer<AttributeOptionDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.translations,
      specifiedType: const FullType(BuiltList, [FullType(AttributeOptionTranslationDto)]),
    );
