...
/// * [attributes] 
@BuiltValue()
abstract class AdminCatalogProductTypeDto implements Built<AdminCatalogProductTypeDto, AdminCatalogProductTypeDtoBuilder> {
  ...
  factory AdminCatalogProductTypeDto([void updates(AdminCatalogProductTypeDtoBuilder b)]) = _$AdminCatalogProductTypeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogProductTypeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogProductTypeDto> get serializer => _$AdminCatalogProductTypeDtoSerializer();
}

class _$AdminCatalogProductTypeDtoSerializer implements PrimitiveSerializer<AdminCatalogProductTypeDto> {
  @override
  final Iterable<Type> types = const [AdminCatalogProductTypeDto, _$AdminCatalogProductTypeDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.attributes != null) {
      ...
      yield serializers.serialize(
        object.attributes,
        specifiedType: const FullType(BuiltList, [FullType(AdminCatalogProductTypeAttributeDto)]),
      );
    }
  }
