...
/// * [shipping] 
@BuiltValue()
abstract class LegalReferencesResponseDto implements Built<LegalReferencesResponseDto, LegalReferencesResponseDtoBuilder> {
  ...
  factory LegalReferencesResponseDto([void updates(LegalReferencesResponseDtoBuilder b)]) = _$LegalReferencesResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LegalReferencesResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LegalReferencesResponseDto> get serializer => _$LegalReferencesResponseDtoSerializer();
}

class _$LegalReferencesResponseDtoSerializer implements PrimitiveSerializer<LegalReferencesResponseDto> {
  @override
  final Iterable<Type> types = const [LegalReferencesResponseDto, _$LegalReferencesResponseDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield r'privacy';
    yield object.privacy == null ? null : serializers.serialize(
      object.privacy,
      specifiedType: const FullType.nullable(PublicLegalReferenceDto),
    );
    yield r'returns';
    yield object.returns == null ? null : serializers.serialize(
      object.returns,
      specifiedType: const FullType.nullable(PublicLegalReferenceDto),
    );
    yield r'shipping';
