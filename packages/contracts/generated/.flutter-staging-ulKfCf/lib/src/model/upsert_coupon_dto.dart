...
@BuiltValue()
abstract class UpsertCouponDto implements Built<UpsertCouponDto, UpsertCouponDtoBuilder> {
  /// Unique coupon code
  ...
  factory UpsertCouponDto([void updates(UpsertCouponDtoBuilder b)]) = _$UpsertCouponDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertCouponDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertCouponDto> get serializer => _$UpsertCouponDtoSerializer();
}

class _$UpsertCouponDtoSerializer implements PrimitiveSerializer<UpsertCouponDto> {
  @override
...
class UpsertCouponDtoStatusEnum extends EnumClass {
  ...
  static const UpsertCouponDtoStatusEnum ACTIVE = _$upsertCouponDtoStatusEnum_ACTIVE;
  /// Coupon status
  @BuiltValueEnumConst(wireName: r'DISABLED')
  static const UpsertCouponDtoStatusEnum DISABLED = _$upsertCouponDtoStatusEnum_DISABLED;
  /// Coupon status
  @BuiltValueEnumConst(wireName: r'ARCHIVED')
  static const UpsertCouponDtoStatusEnum ARCHIVED = _$upsertCouponDtoStatusEnum_ARCHIVED;

  static Serializer<UpsertCouponDtoStatusEnum> get serializer => _$upsertCouponDtoStatusEnumSerializer;

  const UpsertCouponDtoStatusEnum._(String name): super(name);

  static BuiltSet<UpsertCouponDtoStatusEnum> get values => _$upsertCouponDtoStatusEnumValues;
  static UpsertCouponDtoStatusEnum valueOf(String name) => _$upsertCouponDtoStatusEnumValueOf(name);
}
