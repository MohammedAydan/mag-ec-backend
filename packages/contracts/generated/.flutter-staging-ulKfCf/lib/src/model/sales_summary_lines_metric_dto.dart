...
/// * [sum] 
@BuiltValue()
abstract class SalesSummaryLinesMetricDto implements Built<SalesSummaryLinesMetricDto, SalesSummaryLinesMetricDtoBuilder> {
  ...
  factory SalesSummaryLinesMetricDto([void updates(SalesSummaryLinesMetricDtoBuilder b)]) = _$SalesSummaryLinesMetricDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalesSummaryLinesMetricDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalesSummaryLinesMetricDto> get serializer => _$SalesSummaryLinesMetricDtoSerializer();
}

class _$SalesSummaryLinesMetricDtoSerializer implements PrimitiveSerializer<SalesSummaryLinesMetricDto> {
  @override
  final Iterable<Type> types = const [SalesSummaryLinesMetricDto, _$SalesSummaryLinesMetricDto];
