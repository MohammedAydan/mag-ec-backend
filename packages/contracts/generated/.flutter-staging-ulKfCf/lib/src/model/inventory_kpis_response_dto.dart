...
/// * [warehouses] 
@BuiltValue()
abstract class InventoryKpisResponseDto implements Built<InventoryKpisResponseDto, InventoryKpisResponseDtoBuilder> {
  ...
  factory InventoryKpisResponseDto([void updates(InventoryKpisResponseDtoBuilder b)]) = _$InventoryKpisResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InventoryKpisResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InventoryKpisResponseDto> get serializer => _$InventoryKpisResponseDtoSerializer();
}

class _$InventoryKpisResponseDtoSerializer implements PrimitiveSerializer<InventoryKpisResponseDto> {
  @override
  final Iterable<Type> types = const [InventoryKpisResponseDto, _$InventoryKpisResponseDto];
