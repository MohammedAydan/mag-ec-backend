...
/// * [userId] 
@BuiltValue()
abstract class CartResponseDto implements Built<CartResponseDto, CartResponseDtoBuilder> {
  ...
  factory CartResponseDto([void updates(CartResponseDtoBuilder b)]) = _$CartResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CartResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CartResponseDto> get serializer => _$CartResponseDtoSerializer();
}

class _$CartResponseDtoSerializer implements PrimitiveSerializer<CartResponseDto> {
  @override
