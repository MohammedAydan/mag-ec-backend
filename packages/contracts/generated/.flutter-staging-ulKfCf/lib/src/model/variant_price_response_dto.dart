...
/// * [taxClassId] 
@BuiltValue()
abstract class VariantPriceResponseDto implements Built<VariantPriceResponseDto, VariantPriceResponseDtoBuilder> {
  ...
  factory VariantPriceResponseDto([void updates(VariantPriceResponseDtoBuilder b)]) = _$VariantPriceResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VariantPriceResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VariantPriceResponseDto> get serializer => _$VariantPriceResponseDtoSerializer();
}

class _$VariantPriceResponseDtoSerializer implements PrimitiveSerializer<VariantPriceResponseDto> {
  @override
  final Iterable<Type> types = const [VariantPriceResponseDto, _$VariantPriceResponseDto];
