...
/// * [expiresInSeconds] 
@BuiltValue()
abstract class ReportExportDownloadResponseDto implements Built<ReportExportDownloadResponseDto, ReportExportDownloadResponseDtoBuilder> {
  ...
  factory ReportExportDownloadResponseDto([void updates(ReportExportDownloadResponseDtoBuilder b)]) = _$ReportExportDownloadResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReportExportDownloadResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReportExportDownloadResponseDto> get serializer => _$ReportExportDownloadResponseDtoSerializer();
}

class _$ReportExportDownloadResponseDtoSerializer implements PrimitiveSerializer<ReportExportDownloadResponseDto> {
  @override
  final Iterable<Type> types = const [ReportExportDownloadResponseDto, _$ReportExportDownloadResponseDto];
