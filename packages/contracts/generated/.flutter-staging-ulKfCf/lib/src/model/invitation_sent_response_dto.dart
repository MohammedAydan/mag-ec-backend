...
/// * [invitationSent] 
@BuiltValue()
abstract class InvitationSentResponseDto implements Built<InvitationSentResponseDto, InvitationSentResponseDtoBuilder> {
  @BuiltValueField(wireName: r'invitationSent')
  bool get invitationSent;

  InvitationSentResponseDto._();

  factory InvitationSentResponseDto([void updates(InvitationSentResponseDtoBuilder b)]) = _$InvitationSentResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvitationSentResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvitationSentResponseDto> get serializer => _$InvitationSentResponseDtoSerializer();
}

class _$InvitationSentResponseDtoSerializer implements PrimitiveSerializer<InvitationSentResponseDto> {
  @override
  final Iterable<Type> types = const [InvitationSentResponseDto, _$InvitationSentResponseDto];
