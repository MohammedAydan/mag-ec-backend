...
/// * [processedAt] 
@BuiltValue()
abstract class PaymentWebhookEventResponseDto implements Built<PaymentWebhookEventResponseDto, PaymentWebhookEventResponseDtoBuilder> {
  ...
  factory PaymentWebhookEventResponseDto([void updates(PaymentWebhookEventResponseDtoBuilder b)]) = _$PaymentWebhookEventResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentWebhookEventResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentWebhookEventResponseDto> get serializer => _$PaymentWebhookEventResponseDtoSerializer();
}

class _$PaymentWebhookEventResponseDtoSerializer implements PrimitiveSerializer<PaymentWebhookEventResponseDto> {
  @override
  final Iterable<Type> types = const [PaymentWebhookEventResponseDto, _$PaymentWebhookEventResponseDto];
