...
@BuiltValue()
abstract class UpdateLegalReferencesDto implements Built<UpdateLegalReferencesDto, UpdateLegalReferencesDtoBuilder> {
  ...
  factory UpdateLegalReferencesDto([void updates(UpdateLegalReferencesDtoBuilder b)]) = _$UpdateLegalReferencesDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateLegalReferencesDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateLegalReferencesDto> get serializer => _$UpdateLegalReferencesDtoSerializer();
}

class _$UpdateLegalReferencesDtoSerializer implements PrimitiveSerializer<UpdateLegalReferencesDto> {
  @override
  final Iterable<Type> types = const [UpdateLegalReferencesDto, _$UpdateLegalReferencesDto];
