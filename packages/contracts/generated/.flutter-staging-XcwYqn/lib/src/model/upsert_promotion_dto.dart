...
@BuiltValue()
abstract class UpsertPromotionDto implements Built<UpsertPromotionDto, UpsertPromotionDtoBuilder> {
  ...
  factory UpsertPromotionDto([void updates(UpsertPromotionDtoBuilder b)]) = _$UpsertPromotionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertPromotionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertPromotionDto> get serializer => _$UpsertPromotionDtoSerializer();
}

class _$UpsertPromotionDtoSerializer implements PrimitiveSerializer<UpsertPromotionDto> {
  @override
...
class UpsertPromotionDtoStatusEnum extends EnumClass {
  ...
  static const UpsertPromotionDtoStatusEnum DRAFT = _$upsertPromotionDtoStatusEnum_DRAFT;
  /// Promotion status
  @BuiltValueEnumConst(wireName: r'ACTIVE')
  static const UpsertPromotionDtoStatusEnum ACTIVE = _$upsertPromotionDtoStatusEnum_ACTIVE;
  /// Promotion status
  @BuiltValueEnumConst(wireName: r'ARCHIVED')
  static const UpsertPromotionDtoStatusEnum ARCHIVED = _$upsertPromotionDtoStatusEnum_ARCHIVED;

  static Serializer<UpsertPromotionDtoStatusEnum> get serializer => _$upsertPromotionDtoStatusEnumSerializer;

  const UpsertPromotionDtoStatusEnum._(String name): super(name);

  static BuiltSet<UpsertPromotionDtoStatusEnum> get values => _$upsertPromotionDtoStatusEnumValues;
  static UpsertPromotionDtoStatusEnum valueOf(String name) => _$upsertPromotionDtoStatusEnumValueOf(name);
}
...
class UpsertPromotionDtoTriggerEnum extends EnumClass {
  ...
  static const UpsertPromotionDtoTriggerEnum AUTOMATIC = _$upsertPromotionDtoTriggerEnum_AUTOMATIC;
  /// How the promotion is triggered
  @BuiltValueEnumConst(wireName: r'COUPON')
  static const UpsertPromotionDtoTriggerEnum COUPON = _$upsertPromotionDtoTriggerEnum_COUPON;

  static Serializer<UpsertPromotionDtoTriggerEnum> get serializer => _$upsertPromotionDtoTriggerEnumSerializer;

  const UpsertPromotionDtoTriggerEnum._(String name): super(name);

  static BuiltSet<UpsertPromotionDtoTriggerEnum> get values => _$upsertPromotionDtoTriggerEnumValues;
  static UpsertPromotionDtoTriggerEnum valueOf(String name) => _$upsertPromotionDtoTriggerEnumValueOf(name);
}
...
class UpsertPromotionDtoRewardTypeEnum extends EnumClass {
  ...
  static const UpsertPromotionDtoRewardTypeEnum FIXED_AMOUNT = _$upsertPromotionDtoRewardTypeEnum_FIXED_AMOUNT;
  /// Type of discount reward
  @BuiltValueEnumConst(wireName: r'PERCENTAGE')
  static const UpsertPromotionDtoRewardTypeEnum PERCENTAGE = _$upsertPromotionDtoRewardTypeEnum_PERCENTAGE;
  /// Type of discount reward
  @BuiltValueEnumConst(wireName: r'FREE_SHIPPING')
  static const UpsertPromotionDtoRewardTypeEnum FREE_SHIPPING = _$upsertPromotionDtoRewardTypeEnum_FREE_SHIPPING;

  static Serializer<UpsertPromotionDtoRewardTypeEnum> get serializer => _$upsertPromotionDtoRewardTypeEnumSerializer;

  const UpsertPromotionDtoRewardTypeEnum._(String name): super(name);

  static BuiltSet<UpsertPromotionDtoRewardTypeEnum> get values => _$upsertPromotionDtoRewardTypeEnumValues;
  static UpsertPromotionDtoRewardTypeEnum valueOf(String name) => _$upsertPromotionDtoRewardTypeEnumValueOf(name);
}
