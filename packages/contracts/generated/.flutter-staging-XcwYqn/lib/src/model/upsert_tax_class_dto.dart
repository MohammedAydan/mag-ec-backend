...
@BuiltValue()
abstract class UpsertTaxClassDto implements Built<UpsertTaxClassDto, UpsertTaxClassDtoBuilder> {
  ...
  factory UpsertTaxClassDto([void updates(UpsertTaxClassDtoBuilder b)]) = _$UpsertTaxClassDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertTaxClassDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertTaxClassDto> get serializer => _$UpsertTaxClassDtoSerializer();
}

class _$UpsertTaxClassDtoSerializer implements PrimitiveSerializer<UpsertTaxClassDto> {
  @override
