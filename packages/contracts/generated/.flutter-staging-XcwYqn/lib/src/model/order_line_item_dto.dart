...
/// * [unitSaleAmount] 
@BuiltValue()
abstract class OrderLineItemDto implements Built<OrderLineItemDto, OrderLineItemDtoBuilder> {
  ...
  factory OrderLineItemDto([void updates(OrderLineItemDtoBuilder b)]) = _$OrderLineItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderLineItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderLineItemDto> get serializer => _$OrderLineItemDtoSerializer();
}

class _$OrderLineItemDtoSerializer implements PrimitiveSerializer<OrderLineItemDto> {
  @override
