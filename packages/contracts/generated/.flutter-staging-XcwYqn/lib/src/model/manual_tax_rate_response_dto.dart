...
/// * [updatedAt] 
@BuiltValue()
abstract class ManualTaxRateResponseDto implements Built<ManualTaxRateResponseDto, ManualTaxRateResponseDtoBuilder> {
  ...
  factory ManualTaxRateResponseDto([void updates(ManualTaxRateResponseDtoBuilder b)]) = _$ManualTaxRateResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ManualTaxRateResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ManualTaxRateResponseDto> get serializer => _$ManualTaxRateResponseDtoSerializer();
}

class _$ManualTaxRateResponseDtoSerializer implements PrimitiveSerializer<ManualTaxRateResponseDto> {
  @override
  final Iterable<Type> types = const [ManualTaxRateResponseDto, _$ManualTaxRateResponseDto];
