...
class _$CheckoutPreviewResponseDtoSerializer implements PrimitiveSerializer<CheckoutPreviewResponseDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(BuiltList, [FullType(CheckoutPreviewAppliedPromotionDto)]),
    );
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(CheckoutPreviewItemResponseDto)]),
    );
    yield r'shippingMethods';
    yield serializers.serialize(
      object.shippingMethods,
      specifiedType: const FullType(BuiltList, [FullType(CheckoutPreviewShippingMethodDto)]),
    );
