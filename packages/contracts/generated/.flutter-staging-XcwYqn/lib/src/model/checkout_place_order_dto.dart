...
@BuiltValue()
abstract class CheckoutPlaceOrderDto implements Built<CheckoutPlaceOrderDto, CheckoutPlaceOrderDtoBuilder> {
  ...
  factory CheckoutPlaceOrderDto([void updates(CheckoutPlaceOrderDtoBuilder b)]) = _$CheckoutPlaceOrderDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPlaceOrderDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPlaceOrderDto> get serializer => _$CheckoutPlaceOrderDtoSerializer();
}

class _$CheckoutPlaceOrderDtoSerializer implements PrimitiveSerializer<CheckoutPlaceOrderDto> {
  @override
  final Iterable<Type> types = const [CheckoutPlaceOrderDto, _$CheckoutPlaceOrderDto];
...
class CheckoutPlaceOrderDtoPaymentMethodEnum extends EnumClass {
  ...
  static const CheckoutPlaceOrderDtoPaymentMethodEnum cashOnDelivery = _$checkoutPlaceOrderDtoPaymentMethodEnum_cashOnDelivery;
  /// Payment method
  @BuiltValueEnumConst(wireName: r'online_card')
  static const CheckoutPlaceOrderDtoPaymentMethodEnum onlineCard = _$checkoutPlaceOrderDtoPaymentMethodEnum_onlineCard;

  static Serializer<CheckoutPlaceOrderDtoPaymentMethodEnum> get serializer => _$checkoutPlaceOrderDtoPaymentMethodEnumSerializer;

  const CheckoutPlaceOrderDtoPaymentMethodEnum._(String name): super(name);

  static BuiltSet<CheckoutPlaceOrderDtoPaymentMethodEnum> get values => _$checkoutPlaceOrderDtoPaymentMethodEnumValues;
  static CheckoutPlaceOrderDtoPaymentMethodEnum valueOf(String name) => _$checkoutPlaceOrderDtoPaymentMethodEnumValueOf(name);
}
