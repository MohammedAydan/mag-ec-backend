...
@BuiltValue()
abstract class ReviewReturnRequestDto implements Built<ReviewReturnRequestDto, ReviewReturnRequestDtoBuilder> {
  ...
  factory ReviewReturnRequestDto([void updates(ReviewReturnRequestDtoBuilder b)]) = _$ReviewReturnRequestDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReviewReturnRequestDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReviewReturnRequestDto> get serializer => _$ReviewReturnRequestDtoSerializer();
}

class _$ReviewReturnRequestDtoSerializer implements PrimitiveSerializer<ReviewReturnRequestDto> {
  @override
  final Iterable<Type> types = const [ReviewReturnRequestDto, _$ReviewReturnRequestDto];
...
class ReviewReturnRequestDtoDecisionEnum extends EnumClass {
  ...
  static const ReviewReturnRequestDtoDecisionEnum approve = _$reviewReturnRequestDtoDecisionEnum_approve;
  /// Review decision for the return request
  @BuiltValueEnumConst(wireName: r'reject')
  static const ReviewReturnRequestDtoDecisionEnum reject = _$reviewReturnRequestDtoDecisionEnum_reject;

  static Serializer<ReviewReturnRequestDtoDecisionEnum> get serializer => _$reviewReturnRequestDtoDecisionEnumSerializer;

  const ReviewReturnRequestDtoDecisionEnum._(String name): super(name);

  static BuiltSet<ReviewReturnRequestDtoDecisionEnum> get values => _$reviewReturnRequestDtoDecisionEnumValues;
  static ReviewReturnRequestDtoDecisionEnum valueOf(String name) => _$reviewReturnRequestDtoDecisionEnumValueOf(name);
}
