...
/// * [nextCursor] 
@BuiltValue()
abstract class PaginatedRefundsDto implements Built<PaginatedRefundsDto, PaginatedRefundsDtoBuilder> {
  ...
  factory PaginatedRefundsDto([void updates(PaginatedRefundsDtoBuilder b)]) = _$PaginatedRefundsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedRefundsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedRefundsDto> get serializer => _$PaginatedRefundsDtoSerializer();
}

class _$PaginatedRefundsDtoSerializer implements PrimitiveSerializer<PaginatedRefundsDto> {
  @override
  final Iterable<Type> types = const [PaginatedRefundsDto, _$PaginatedRefundsDto];
