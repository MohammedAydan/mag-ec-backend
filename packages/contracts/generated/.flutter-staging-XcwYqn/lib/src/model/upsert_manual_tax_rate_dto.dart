...
@BuiltValue()
abstract class UpsertManualTaxRateDto implements Built<UpsertManualTaxRateDto, UpsertManualTaxRateDtoBuilder> {
  ...
  factory UpsertManualTaxRateDto([void updates(UpsertManualTaxRateDtoBuilder b)]) = _$UpsertManualTaxRateDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpsertManualTaxRateDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpsertManualTaxRateDto> get serializer => _$UpsertManualTaxRateDtoSerializer();
}

class _$UpsertManualTaxRateDtoSerializer implements PrimitiveSerializer<UpsertManualTaxRateDto> {
  @override
  final Iterable<Type> types = const [UpsertManualTaxRateDto, _$UpsertManualTaxRateDto];
