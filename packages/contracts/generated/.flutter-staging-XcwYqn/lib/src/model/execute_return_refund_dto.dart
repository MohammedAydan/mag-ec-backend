...
@BuiltValue()
abstract class ExecuteReturnRefundDto implements Built<ExecuteReturnRefundDto, ExecuteReturnRefundDtoBuilder> {
  ...
  factory ExecuteReturnRefundDto([void updates(ExecuteReturnRefundDtoBuilder b)]) = _$ExecuteReturnRefundDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExecuteReturnRefundDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExecuteReturnRefundDto> get serializer => _$ExecuteReturnRefundDtoSerializer();
}

class _$ExecuteReturnRefundDtoSerializer implements PrimitiveSerializer<ExecuteReturnRefundDto> {
  @override
  final Iterable<Type> types = const [ExecuteReturnRefundDto, _$ExecuteReturnRefundDto];
