...
/// * [checksum] 
@BuiltValue()
abstract class AdminCatalogMediaDto implements Built<AdminCatalogMediaDto, AdminCatalogMediaDtoBuilder> {
  ...
  factory AdminCatalogMediaDto([void updates(AdminCatalogMediaDtoBuilder b)]) = _$AdminCatalogMediaDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogMediaDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogMediaDto> get serializer => _$AdminCatalogMediaDtoSerializer();
}

class _$AdminCatalogMediaDtoSerializer implements PrimitiveSerializer<AdminCatalogMediaDto> {
  @override
  final Iterable<Type> types = const [AdminCatalogMediaDto, _$AdminCatalogMediaDto];
