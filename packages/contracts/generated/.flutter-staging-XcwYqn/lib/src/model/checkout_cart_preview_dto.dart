...
@BuiltValue()
abstract class CheckoutCartPreviewDto implements Built<CheckoutCartPreviewDto, CheckoutCartPreviewDtoBuilder> {
  ...
  factory CheckoutCartPreviewDto([void updates(CheckoutCartPreviewDtoBuilder b)]) = _$CheckoutCartPreviewDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutCartPreviewDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutCartPreviewDto> get serializer => _$CheckoutCartPreviewDtoSerializer();
}

class _$CheckoutCartPreviewDtoSerializer implements PrimitiveSerializer<CheckoutCartPreviewDto> {
  @override
  final Iterable<Type> types = const [CheckoutCartPreviewDto, _$CheckoutCartPreviewDto];
