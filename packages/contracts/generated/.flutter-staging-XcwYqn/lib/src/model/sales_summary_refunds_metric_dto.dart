...
/// * [sum] 
@BuiltValue()
abstract class SalesSummaryRefundsMetricDto implements Built<SalesSummaryRefundsMetricDto, SalesSummaryRefundsMetricDtoBuilder> {
  ...
  factory SalesSummaryRefundsMetricDto([void updates(SalesSummaryRefundsMetricDtoBuilder b)]) = _$SalesSummaryRefundsMetricDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalesSummaryRefundsMetricDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalesSummaryRefundsMetricDto> get serializer => _$SalesSummaryRefundsMetricDtoSerializer();
}

class _$SalesSummaryRefundsMetricDtoSerializer implements PrimitiveSerializer<SalesSummaryRefundsMetricDto> {
  @override
  final Iterable<Type> types = const [SalesSummaryRefundsMetricDto, _$SalesSummaryRefundsMetricDto];
