...
/// * [translations] 
@BuiltValue()
abstract class AdminCatalogTagDto implements Built<AdminCatalogTagDto, AdminCatalogTagDtoBuilder> {
  ...
  factory AdminCatalogTagDto([void updates(AdminCatalogTagDtoBuilder b)]) = _$AdminCatalogTagDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogTagDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogTagDto> get serializer => _$AdminCatalogTagDtoSerializer();
}

class _$AdminCatalogTagDtoSerializer implements PrimitiveSerializer<AdminCatalogTagDto> {
  @override
