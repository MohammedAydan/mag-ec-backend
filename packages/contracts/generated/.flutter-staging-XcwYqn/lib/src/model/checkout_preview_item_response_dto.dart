...
/// * [unitSaleAmount] 
@BuiltValue()
abstract class CheckoutPreviewItemResponseDto implements Built<CheckoutPreviewItemResponseDto, CheckoutPreviewItemResponseDtoBuilder> {
  ...
  factory CheckoutPreviewItemResponseDto([void updates(CheckoutPreviewItemResponseDtoBuilder b)]) = _$CheckoutPreviewItemResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPreviewItemResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPreviewItemResponseDto> get serializer => _$CheckoutPreviewItemResponseDtoSerializer();
}

class _$CheckoutPreviewItemResponseDtoSerializer implements PrimitiveSerializer<CheckoutPreviewItemResponseDto> {
  @override
  final Iterable<Type> types = const [CheckoutPreviewItemResponseDto, _$CheckoutPreviewItemResponseDto];
