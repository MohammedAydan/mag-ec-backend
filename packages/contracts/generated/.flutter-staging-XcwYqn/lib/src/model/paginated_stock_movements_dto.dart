...
/// * [pagination] 
@BuiltValue()
abstract class PaginatedStockMovementsDto implements Built<PaginatedStockMovementsDto, PaginatedStockMovementsDtoBuilder> {
  ...
  factory PaginatedStockMovementsDto([void updates(PaginatedStockMovementsDtoBuilder b)]) = _$PaginatedStockMovementsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedStockMovementsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedStockMovementsDto> get serializer => _$PaginatedStockMovementsDtoSerializer();
}

class _$PaginatedStockMovementsDtoSerializer implements PrimitiveSerializer<PaginatedStockMovementsDto> {
  @override
  final Iterable<Type> types = const [PaginatedStockMovementsDto, _$PaginatedStockMovementsDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(StockMovementItemDto)]),
    );
    yield r'pagination';
    yield serializers.serialize(
      object.pagination,
