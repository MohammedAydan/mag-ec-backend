...
/// * [providerPaymentId] 
@BuiltValue()
abstract class CheckoutPaymentAttemptDto implements Built<CheckoutPaymentAttemptDto, CheckoutPaymentAttemptDtoBuilder> {
  ...
  factory CheckoutPaymentAttemptDto([void updates(CheckoutPaymentAttemptDtoBuilder b)]) = _$CheckoutPaymentAttemptDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPaymentAttemptDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPaymentAttemptDto> get serializer => _$CheckoutPaymentAttemptDtoSerializer();
}

class _$CheckoutPaymentAttemptDtoSerializer implements PrimitiveSerializer<CheckoutPaymentAttemptDto> {
  @override
  final Iterable<Type> types = const [CheckoutPaymentAttemptDto, _$CheckoutPaymentAttemptDto];
