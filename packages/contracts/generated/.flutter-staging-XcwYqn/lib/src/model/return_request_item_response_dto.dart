...
/// * [restockedAt] 
@BuiltValue()
abstract class ReturnRequestItemResponseDto implements Built<ReturnRequestItemResponseDto, ReturnRequestItemResponseDtoBuilder> {
  ...
  factory ReturnRequestItemResponseDto([void updates(ReturnRequestItemResponseDtoBuilder b)]) = _$ReturnRequestItemResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReturnRequestItemResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReturnRequestItemResponseDto> get serializer => _$ReturnRequestItemResponseDtoSerializer();
}

class _$ReturnRequestItemResponseDtoSerializer implements PrimitiveSerializer<ReturnRequestItemResponseDto> {
  @override
  final Iterable<Type> types = const [ReturnRequestItemResponseDto, _$ReturnRequestItemResponseDto];
