...
/// * [price] 
@BuiltValue()
abstract class CatalogVariantSummaryDto implements Built<CatalogVariantSummaryDto, CatalogVariantSummaryDtoBuilder> {
  ...
  factory CatalogVariantSummaryDto([void updates(CatalogVariantSummaryDtoBuilder b)]) = _$CatalogVariantSummaryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CatalogVariantSummaryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CatalogVariantSummaryDto> get serializer => _$CatalogVariantSummaryDtoSerializer();
}

class _$CatalogVariantSummaryDtoSerializer implements PrimitiveSerializer<CatalogVariantSummaryDto> {
  @override
  final Iterable<Type> types = const [CatalogVariantSummaryDto, _$CatalogVariantSummaryDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.options,
      specifiedType: const FullType(BuiltList, [FullType(CatalogVariantOptionSummaryDto)]),
    );
    if (object.name != null) {
      yield r'name';
      yield serializers.serialize(
