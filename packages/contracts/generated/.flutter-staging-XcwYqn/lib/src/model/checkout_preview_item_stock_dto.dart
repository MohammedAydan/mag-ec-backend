...
/// * [isAvailable] 
@BuiltValue()
abstract class CheckoutPreviewItemStockDto implements Built<CheckoutPreviewItemStockDto, CheckoutPreviewItemStockDtoBuilder> {
  ...
  factory CheckoutPreviewItemStockDto([void updates(CheckoutPreviewItemStockDtoBuilder b)]) = _$CheckoutPreviewItemStockDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutPreviewItemStockDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutPreviewItemStockDto> get serializer => _$CheckoutPreviewItemStockDtoSerializer();
}

class _$CheckoutPreviewItemStockDtoSerializer implements PrimitiveSerializer<CheckoutPreviewItemStockDto> {
  @override
  final Iterable<Type> types = const [CheckoutPreviewItemStockDto, _$CheckoutPreviewItemStockDto];
