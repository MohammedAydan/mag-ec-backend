...
/// * [sum] 
@BuiltValue()
abstract class SalesSummaryMetricDto implements Built<SalesSummaryMetricDto, SalesSummaryMetricDtoBuilder> {
  ...
  factory SalesSummaryMetricDto([void updates(SalesSummaryMetricDtoBuilder b)]) = _$SalesSummaryMetricDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalesSummaryMetricDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalesSummaryMetricDto> get serializer => _$SalesSummaryMetricDtoSerializer();
}

class _$SalesSummaryMetricDtoSerializer implements PrimitiveSerializer<SalesSummaryMetricDto> {
  @override
  final Iterable<Type> types = const [SalesSummaryMetricDto, _$SalesSummaryMetricDto];
