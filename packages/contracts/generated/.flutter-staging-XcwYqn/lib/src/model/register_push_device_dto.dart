...
class RegisterPushDeviceDtoPlatformEnum extends EnumClass {
  ...
  static const RegisterPushDeviceDtoPlatformEnum android = _$registerPushDeviceDtoPlatformEnum_android;
  /// Push device platform
  @BuiltValueEnumConst(wireName: r'ios')
  static const RegisterPushDeviceDtoPlatformEnum ios = _$registerPushDeviceDtoPlatformEnum_ios;
  /// Push device platform
  @BuiltValueEnumConst(wireName: r'web')
  static const RegisterPushDeviceDtoPlatformEnum web = _$registerPushDeviceDtoPlatformEnum_web;

  static Serializer<RegisterPushDeviceDtoPlatformEnum> get serializer => _$registerPushDeviceDtoPlatformEnumSerializer;

  const RegisterPushDeviceDtoPlatformEnum._(String name): super(name);

  static BuiltSet<RegisterPushDeviceDtoPlatformEnum> get values => _$registerPushDeviceDtoPlatformEnumValues;
  static RegisterPushDeviceDtoPlatformEnum valueOf(String name) => _$registerPushDeviceDtoPlatformEnumValueOf(name);
}
