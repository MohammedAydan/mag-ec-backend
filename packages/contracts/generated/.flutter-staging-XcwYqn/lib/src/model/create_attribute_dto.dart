...
class _$CreateAttributeDtoSerializer implements PrimitiveSerializer<CreateAttributeDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.translations,
      specifiedType: const FullType(BuiltList, [FullType(AttributeTranslationDto)]),
    );
    ...
    if (object.options != null) {
      ...
      yield serializers.serialize(
        object.options,
        specifiedType: const FullType(BuiltList, [FullType(AttributeOptionDto)]),
      );
    }
  }
...
class CreateAttributeDtoInputTypeEnum extends EnumClass {
  ...
  static const CreateAttributeDtoInputTypeEnum TEXT = _$createAttributeDtoInputTypeEnum_TEXT;
  @BuiltValueEnumConst(wireName: r'SELECT')
  static const CreateAttributeDtoInputTypeEnum SELECT = _$createAttributeDtoInputTypeEnum_SELECT;
  @BuiltValueEnumConst(wireName: r'MULTI_SELECT')
  static const CreateAttributeDtoInputTypeEnum MULTI_SELECT = _$createAttributeDtoInputTypeEnum_MULTI_SELECT;
  @BuiltValueEnumConst(wireName: r'COLOR')
  static const CreateAttributeDtoInputTypeEnum COLOR = _$createAttributeDtoInputTypeEnum_COLOR;
  @BuiltValueEnumConst(wireName: r'SIZE')
  static const CreateAttributeDtoInputTypeEnum SIZE = _$createAttributeDtoInputTypeEnum_SIZE;
  @BuiltValueEnumConst(wireName: r'BOOLEAN')
  static const CreateAttributeDtoInputTypeEnum BOOLEAN = _$createAttributeDtoInputTypeEnum_BOOLEAN;
  @BuiltValueEnumConst(wireName: r'NUMBER')
  static const CreateAttributeDtoInputTypeEnum NUMBER = _$createAttributeDtoInputTypeEnum_NUMBER;

  static Serializer<CreateAttributeDtoInputTypeEnum> get serializer => _$createAttributeDtoInputTypeEnumSerializer;

  const CreateAttributeDtoInputTypeEnum._(String name): super(name);

  static BuiltSet<CreateAttributeDtoInputTypeEnum> get values => _$createAttributeDtoInputTypeEnumValues;
  static CreateAttributeDtoInputTypeEnum valueOf(String name) => _$createAttributeDtoInputTypeEnumValueOf(name);
}
