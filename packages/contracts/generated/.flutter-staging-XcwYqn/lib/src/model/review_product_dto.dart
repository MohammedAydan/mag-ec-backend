...
/// * [translations] 
@BuiltValue()
abstract class ReviewProductDto implements Built<ReviewProductDto, ReviewProductDtoBuilder> {
  ...
  factory ReviewProductDto([void updates(ReviewProductDtoBuilder b)]) = _$ReviewProductDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReviewProductDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReviewProductDto> get serializer => _$ReviewProductDtoSerializer();
}

class _$ReviewProductDtoSerializer implements PrimitiveSerializer<ReviewProductDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.translations,
      specifiedType: const FullType(BuiltList, [FullType(ReviewProductTranslationDto)]),
    );
  }
