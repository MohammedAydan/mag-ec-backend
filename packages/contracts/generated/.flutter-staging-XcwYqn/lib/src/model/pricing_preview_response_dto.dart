...
/// * [shippingMethods] 
@BuiltValue()
abstract class PricingPreviewResponseDto implements Built<PricingPreviewResponseDto, PricingPreviewResponseDtoBuilder> {
  ...
  factory PricingPreviewResponseDto([void updates(PricingPreviewResponseDtoBuilder b)]) = _$PricingPreviewResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PricingPreviewResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PricingPreviewResponseDto> get serializer => _$PricingPreviewResponseDtoSerializer();
}

class _$PricingPreviewResponseDtoSerializer implements PrimitiveSerializer<PricingPreviewResponseDto> {
  @override
  final Iterable<Type> types = const [PricingPreviewResponseDto, _$PricingPreviewResponseDto];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(PricingPreviewLineItemDto)]),
    );
    yield r'appliedPromotions';
    yield serializers.serialize(
      object.appliedPromotions,
      specifiedType: const FullType(BuiltList, [FullType(PricingPreviewAppliedPromotionDto)]),
    );
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(BuiltList, [FullType(PricingPreviewShippingMethodDto)]),
    );
  }
