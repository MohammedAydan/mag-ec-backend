...
/// * [colorHex] 
@BuiltValue()
abstract class AdminCatalogAttributeOptionDto implements Built<AdminCatalogAttributeOptionDto, AdminCatalogAttributeOptionDtoBuilder> {
  ...
  factory AdminCatalogAttributeOptionDto([void updates(AdminCatalogAttributeOptionDtoBuilder b)]) = _$AdminCatalogAttributeOptionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminCatalogAttributeOptionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminCatalogAttributeOptionDto> get serializer => _$AdminCatalogAttributeOptionDtoSerializer();
}

class _$AdminCatalogAttributeOptionDtoSerializer implements PrimitiveSerializer<AdminCatalogAttributeOptionDto> {
  @override
  final Iterable<Type> types = const [AdminCatalogAttributeOptionDto, _$AdminCatalogAttributeOptionDto];
