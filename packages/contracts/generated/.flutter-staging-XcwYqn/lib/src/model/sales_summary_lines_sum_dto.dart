...
/// * [taxAmount] 
@BuiltValue()
abstract class SalesSummaryLinesSumDto implements Built<SalesSummaryLinesSumDto, SalesSummaryLinesSumDtoBuilder> {
  ...
  factory SalesSummaryLinesSumDto([void updates(SalesSummaryLinesSumDtoBuilder b)]) = _$SalesSummaryLinesSumDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalesSummaryLinesSumDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalesSummaryLinesSumDto> get serializer => _$SalesSummaryLinesSumDtoSerializer();
}

class _$SalesSummaryLinesSumDtoSerializer implements PrimitiveSerializer<SalesSummaryLinesSumDto> {
  @override
  final Iterable<Type> types = const [SalesSummaryLinesSumDto, _$SalesSummaryLinesSumDto];
