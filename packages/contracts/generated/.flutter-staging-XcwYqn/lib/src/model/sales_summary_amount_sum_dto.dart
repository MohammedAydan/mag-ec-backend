...
/// * [shippingAmount] 
@BuiltValue()
abstract class SalesSummaryAmountSumDto implements Built<SalesSummaryAmountSumDto, SalesSummaryAmountSumDtoBuilder> {
  ...
  factory SalesSummaryAmountSumDto([void updates(SalesSummaryAmountSumDtoBuilder b)]) = _$SalesSummaryAmountSumDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalesSummaryAmountSumDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalesSummaryAmountSumDto> get serializer => _$SalesSummaryAmountSumDtoSerializer();
}

class _$SalesSummaryAmountSumDtoSerializer implements PrimitiveSerializer<SalesSummaryAmountSumDto> {
  @override
  final Iterable<Type> types = const [SalesSummaryAmountSumDto, _$SalesSummaryAmountSumDto];
